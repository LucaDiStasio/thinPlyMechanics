...
*DIM, UnCrackDisps, ARRAY, NNodes, 11
!*GET,nodeLabel,NODE,0,NUM,MIN !Get label of the first node
!*DO,i,1,NNodes,1
!  ! Define some parameters
!  *GET,CrackDisps(i,1),NODE,nodeLabel,NUM
*VGET, UnCrackDisps(1,1), NODE, , NLIST
*VGET, UnCrackDisps(1,2), NODE, 1, LOC, Y
*VGET, UnCrackDisps(1,3), NODE, 1, LOC, X
*VGET, UnCrackDisps(1,4), NODE, 1, U, X
*VGET, UnCrackDisps(1,5), NODE, 1, U, Y
*VGET, UnCrackDisps(1,6), NODE, 1, S, X
*VGET, UnCrackDisps(1,7), NODE, 1, S, Y
*VGET, UnCrackDisps(1,8), NODE, 1, S, XY
*VGET, UnCrackDisps(1,9), NODE, 1, EPEL, X
*VGET, UnCrackDisps(1,10), NODE, 1, EPEL, Y
*VGET, UnCrackDisps(1,11), NODE, 1, EPEL, XY
