...
def writeData(outdir,workbookname,data,boundaryCase):
    ...
    subtitleFormat = workbook.add_format({'bold': True, 'font_color': 'black'})
    ...
    gIvcctWorksheet.write(0,0,'GI-VCCT',titleFormat)
    gIjintWorksheet.write(0,0,'GI-Jint',titleFormat)
    gIIvcctWorksheet.write(0,0,'GII-VCCT',titleFormat)
    gTOTvcctWorksheet.write(0,0,'GTOT-VCCT',titleFormat)
    gTOTjintWorksheet.write(0,0,'GTOT-Jint',titleFormat)    
    for ws in [gIvcctWorksheet,gIjintWorksheet,gIIvcctWorksheet,gTOTvcctWorksheet,gTOTjintWorksheet]:
        ws.write(1,0,'BOUNDARY CONDITIONS',subtitleFormat)
        ws.write(2,0,'NORTH',subtitleFormat)
        ws.write(2,1,'SOUTH',subtitleFormat)
        ws.write(2,2,'EAST',subtitleFormat)
        ws.write(2,3,'WEST',subtitleFormat)
        ws.write(2,4,'Vf [%]',subtitleFormat)
        ws.write(2,5,'Value at no debond [J/m^2]',subtitleFormat)
        ws.write(1,6,'Coefficients',subtitleFormat)
        ws.write(2,6,'A [J/m^2]',subtitleFormat)
        ws.write(2,7,'B [1/deg]',subtitleFormat)
        ws.write(2,8,'C [deg]',subtitleFormat)
        ws.write(2,9,'D [J/m^2]',subtitleFormat)
        ws.write(1,10,'Covariance',subtitleFormat)
        ws.write(2,10,'cov(1,1)',subtitleFormat)
        ws.write(2,11,'cov(1,2)',subtitleFormat)
        ws.write(2,12,'cov(1,3)',subtitleFormat)
        ws.write(2,13,'cov(1,4)',subtitleFormat)
        ws.write(2,14,'cov(2,1)',subtitleFormat)
        ws.write(2,15,'cov(2,2)',subtitleFormat)
        ws.write(2,16,'cov(2,3)',subtitleFormat)
        ws.write(2,17,'cov(2,4)',subtitleFormat)
        ws.write(2,18,'cov(3,1)',subtitleFormat)
        ws.write(2,19,'cov(3,2)',subtitleFormat)
        ws.write(2,20,'cov(3,3)',subtitleFormat)
        ws.write(2,21,'cov(3,4)',subtitleFormat)
        ws.write(2,22,'cov(4,1)',subtitleFormat)
        ws.write(2,23,'cov(4,2)',subtitleFormat)
        ws.write(2,24,'cov(4,3)',subtitleFormat)
        ws.write(2,25,'cov(4,4)',subtitleFormat)
        ws.write(1,26,'std err',subtitleFormat)
        ws.write(2,26,'A [J/m^2]',subtitleFormat)
        ws.write(2,27,'B [1/deg]',subtitleFormat)
        ws.write(2,28,'C [deg]',subtitleFormat)
        ws.write(2,29,'D [J/m^2]',subtitleFormat)
    czWorksheet = workbook.add_worksheet('ContactZone')
    czWorksheet.write(0,0,'Contact zone',titleFormat)
    czWorksheet.write(1,0,'BOUNDARY CONDITIONS',subtitleFormat)
    czWorksheet.write(2,0,'NORTH',subtitleFormat)
    czWorksheet.write(2,1,'SOUTH',subtitleFormat)
    czWorksheet.write(2,2,'EAST',subtitleFormat)
    czWorksheet.write(2,3,'WEST',subtitleFormat)
    czWorksheet.write(2,4,'Vf [%]',subtitleFormat)
    czWorksheet.write(1,5,'Coefficients',subtitleFormat)
    czWorksheet.write(2,5,'A [%/deg]',subtitleFormat)
    czWorksheet.write(2,6,'B [%]',subtitleFormat)
    czWorksheet.write(1,7,'Covariance',subtitleFormat)
    czWorksheet.write(2,7,'cov(1,1)',subtitleFormat)
    czWorksheet.write(2,8,'cov(1,2)',subtitleFormat)
    czWorksheet.write(2,9,'cov(2,1)',subtitleFormat)
    czWorksheet.write(2,10,'cov(2,2)',subtitleFormat)
    czWorksheet.write(1,11,'std err',subtitleFormat)
    czWorksheet.write(2,11,'A [%/deg]',subtitleFormat)
    czWorksheet.write(2,12,'B [%]',subtitleFormat)
    Vf = [0.000079,0.0001,0.2,0.3,0.4,0.5,0.55,0.6,0.65]
    nVf = len(Vf)
    initVf = 3
    for c,case in enumerate(boundaryCase):
    ...
    for wsIndex,ws in enumerate([gIvcctWorksheet,gIjintWorksheet,gIIvcctWorksheet,gTOTvcctWorksheet,gTOTjintWorksheet]):
        ...
        chartC.set_title ({'name': 'Phase'})
        chartC.set_y_axis({'name': 'C [deg]'})
        chartC.set_x_axis({'name': 'Vf [%]'})
