...
def writeData(outdir,workbookname,data,boundaryCase):
    ...
    gIvcctWorksheet['A1'] = .write(0,0,'GI-VCCT')
    gIvcctWorksheet['A2'] = .write(1,0,'BOUNDARY CONDITIONS')
    gIvcctWorksheet['A3'] = .write(2,0,'NORTH')
    gIvcctWorksheet['B3'] = .write(0,1,'SOUTH')
    gIvcctWorksheet['C3'] = .write(0,2,'EAST')
    gIvcctWorksheet['D3'] = .write(0,3,'WEST')
    gIvcctWorksheet['E3'] = .write(0,4,'Vf [%]')
    gIvcctWorksheet['F3'] = .write(0,5,'Value at no debond [J/m^2]')
    gIvcctWorksheet['G2'] = .write(0,6,'Coefficients')
    gIvcctWorksheet['G3'] = .write(0,6,'A [J/m^2]')
    gIvcctWorksheet['H3'] = .write(0,7,'B [1/°]')
    gIvcctWorksheet['I3'] = .write(0,8,'C [°]')
    gIvcctWorksheet['J3'] = .write(0,9,'D [J/m^2]')
    gIvcctWorksheet['K2'] = .write(0,10,'Covariance')
    gIvcctWorksheet['K3'] = .write(0,10,'cov(1,1)')
    gIvcctWorksheet['L3'] = .write(0,11,'cov(1,2)')
    gIvcctWorksheet['M3'] = .write(0,12,'cov(1,3)')
    gIvcctWorksheet['N3'] = .write(0,13,'cov(1,4)')
    gIvcctWorksheet['O3'] = .write(0,14,'cov(2,1)')
    gIvcctWorksheet['P3'] = .write(0,15,'cov(2,2)')
    gIvcctWorksheet['Q3'] = .write(0,16,'cov(2,3)')
    gIvcctWorksheet['R3'] = .write(0,17,'cov(2,4)')
    gIvcctWorksheet['S3'] = .write(0,18,'cov(3,1)')
    gIvcctWorksheet['T3'] = .write(0,19,'cov(3,2)')
    gIvcctWorksheet['U3'] = .write(0,20,'cov(3,3)')
    gIvcctWorksheet['V3'] = .write(0,21,'cov(3,4)')
    gIvcctWorksheet['W3'] = .write(0,22,'cov(4,1)')
    gIvcctWorksheet['X3'] = .write(0,23,'cov(4,2)')
    gIvcctWorksheet['Y3'] = .write(0,24,'cov(4,3)')
    gIvcctWorksheet['Z3'] = .write(0,25,'cov(4,4)')
    gIvcctWorksheet['AA2'] = .write(0,26,'std err')
    gIvcctWorksheet['AA3'] = .write(0,26,'A [J/m^2]')
    gIvcctWorksheet['AB3'] = .write(0,27,'B [1/°]')
    gIvcctWorksheet['AC3'] = .write(0,28,'C [°]')
    gIvcctWorksheet['AD3'] = .write(0,29,'D [J/m^2]')
