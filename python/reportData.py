            ...
            for subFolder in subfoldersList:
                ...
                if subFolder.split('/')[-1] + '-strainscircumferentialpaths' + '.csv' in listdir(subFolder):
                    ...
                    for p, pathVariable in enumerate(pathVariables):
                        ...
                        worksheet.write(2,p*25,pathCoordinateName,circumferentialpathsstringFormat)
                        worksheet.write(2,p*25+1,'Norm ' + pathCoordinateName,circumferentialpathsstringFormat)
                        worksheet.write(2,p*25+2,'EExx [mum/mum]',circumferentialpathsstringFormat)
                        worksheet.write(2,p*25+3,'EEyy [mum/mum]',circumferentialpathsstringFormat)
                        worksheet.write(2,p*25+4,'EEzz [mum/mum]',circumferentialpathsstringFormat)
                        worksheet.write(2,p*25+5,'EExy [mum/mum]',circumferentialpathsstringFormat)
                        worksheet.write(2,p*25+6,'EEzx [mum/mum]',circumferentialpathsstringFormat)
                        worksheet.write(2,p*25+7,'EEyz [mum/mum]',circumferentialpathsstringFormat)
                        worksheet.write(2,p*25+8,'EErr [mum/mum]',circumferentialpathsstringFormat)
                        worksheet.write(2,p*25+9,'EEtt [mum/mum]',circumferentialpathsstringFormat)
                        worksheet.write(2,p*25+10,'EErt [mum/mum]',circumferentialpathsstringFormat)
                        worksheet.write(2,p*25+11,'EE1_3D [mum/mum]',circumferentialpathsstringFormat)
                        worksheet.write(2,p*25+12,'EE2_3D [mum/mum]',circumferentialpathsstringFormat)
                        worksheet.write(2,p*25+13,'EE3_3D [mum/mum]',circumferentialpathsstringFormat)
                        worksheet.write(2,p*25+14,'EE1_2D [mum/mum]',circumferentialpathsstringFormat)
                        worksheet.write(2,p*25+15,'EE2_2D [mum/mum]',circumferentialpathsstringFormat)
                        worksheet.write(2,p*25+16,'EEmises_3D [mum/mum]',circumferentialpathsstringFormat)
                        worksheet.write(2,p*25+17,'EEmises_2D [mum/mum]',circumferentialpathsstringFormat)
                        worksheet.write(2,p*25+18,'EEaverage_3D [mum/mum]',circumferentialpathsstringFormat)
                        worksheet.write(2,p*25+19,'EEaverage_2D [mum/mum]',circumferentialpathsstringFormat)
                        worksheet.write(2,p*25+20,'EEI1_3D [mum/mum]',circumferentialpathsstringFormat)
                        worksheet.write(2,p*25+21,'EEI2_3D [(mum/mum)^2]',circumferentialpathsstringFormat)
                        worksheet.write(2,p*25+22,'EEI3_3D [(mum/mum)^3]',circumferentialpathsstringFormat)
                        worksheet.write(2,p*25+23,'EEI1_2D [mum/mum]',circumferentialpathsstringFormat)
                        worksheet.write(2,p*25+24,'EEI2_2D [(mum/mum)^2]',circumferentialpathsstringFormat)
                        measureNum = np.min([len(Sxx[p]),len(Syy[p]),len(Szz[p]),len(Sxy[p])])
                        print('          number of path points = ' + str(measureNum))
                        for c in range(0,measureNum):
                            coord = pathCoords[p][c]
                            worksheet.write(3+c,p*25,coord,circumferentialpathsnumberFormat)
                            worksheet.write(3+c,p*25+1,pathNormCoords[p][c],circumferentialpathsnumberFormat)
                            worksheet.write(3+c,p*25+2,EExx[p][c],circumferentialpathsnumberFormat)
                            worksheet.write(3+c,p*25+3,EEyy[p][c],circumferentialpathsnumberFormat)
                            worksheet.write(3+c,p*25+4,EEzz[p][c],circumferentialpathsnumberFormat)
                            worksheet.write(3+c,p*25+5,EExy[p][c],circumferentialpathsnumberFormat)
                            worksheet.write(3+c,p*25+6,0.0,circumferentialpathsnumberFormat)
                            worksheet.write(3+c,p*25+7,0.0,circumferentialpathsnumberFormat)
                            worksheet.write(3+c,p*25+8,EErr[p][c],circumferentialpathsnumberFormat)
                            worksheet.write(3+c,p*25+9,EEtt[p][c],circumferentialpathsnumberFormat)
                            worksheet.write(3+c,p*25+10,EErt[p][c],circumferentialpathsnumberFormat)
                            worksheet.write(3+c,p*25+11,EE1D3[p][c],circumferentialpathsnumberFormat)
                            worksheet.write(3+c,p*25+12,EE2D3[p][c],circumferentialpathsnumberFormat)
                            worksheet.write(3+c,p*25+13,EE3D3[p][c],circumferentialpathsnumberFormat)
                            worksheet.write(3+c,p*25+14,EE1D2[p][c],circumferentialpathsnumberFormat)
                            worksheet.write(3+c,p*25+15,EE2D2[p][c],circumferentialpathsnumberFormat)
                            worksheet.write(3+c,p*25+16,EEMisesD3[p][c],circumferentialpathsnumberFormat)
                            worksheet.write(3+c,p*25+17,EEMisesD2[p][c],circumferentialpathsnumberFormat)
                            worksheet.write(3+c,p*25+18,EEaverD3[p][c],circumferentialpathsnumberFormat)
                            worksheet.write(3+c,p*25+19,EEaverD2[p][c],circumferentialpathsnumberFormat)
                            worksheet.write(3+c,p*25+20,EEI1D3[p][c],circumferentialpathsnumberFormat)
                            worksheet.write(3+c,p*25+21,EEI2D3[p][c],circumferentialpathsnumberFormat)
                            worksheet.write(3+c,p*25+22,EEI3D3[p][c],circumferentialpathsnumberFormat)
                            worksheet.write(3+c,p*25+23,EEI1D2[p][c],circumferentialpathsnumberFormat)
                            worksheet.write(3+c,p*25+24,EEI2D2[p][c],circumferentialpathsnumberFormat)
                ...
                if subFolder.split('/')[-1] + '-strainshorizontalpaths' + '.csv' in listdir(subFolder):
                    ...
                    for p, pathVariable in enumerate(pathVariables):
                        ...
                        worksheet.write(2,p*25,pathCoordinateName,horizontalpathsstringFormat)
                        worksheet.write(2,p*25+1,'Norm ' + pathCoordinateName,horizontalpathsstringFormat)
                        worksheet.write(2,p*25+2,'EExx [mum/mum]',horizontalpathsstringFormat)
                        worksheet.write(2,p*25+3,'EEyy [mum/mum]',horizontalpathsstringFormat)
                        worksheet.write(2,p*25+4,'EEzz [mum/mum]',horizontalpathsstringFormat)
                        worksheet.write(2,p*25+5,'EExy [mum/mum]',horizontalpathsstringFormat)
                        worksheet.write(2,p*25+6,'EEzx [mum/mum]',horizontalpathsstringFormat)
                        worksheet.write(2,p*25+7,'EEyz [mum/mum]',horizontalpathsstringFormat)
                        worksheet.write(2,p*25+8,'EErr [mum/mum]',horizontalpathsstringFormat)
                        worksheet.write(2,p*25+9,'EEtt [mum/mum]',horizontalpathsstringFormat)
                        worksheet.write(2,p*25+10,'EErt [mum/mum]',horizontalpathsstringFormat)
                        worksheet.write(2,p*25+11,'EE1_3D [mum/mum]',horizontalpathsstringFormat)
                        worksheet.write(2,p*25+12,'EE2_3D [mum/mum]',horizontalpathsstringFormat)
                        worksheet.write(2,p*25+13,'EE3_3D [mum/mum]',horizontalpathsstringFormat)
                        worksheet.write(2,p*25+14,'EE1_2D [mum/mum]',horizontalpathsstringFormat)
                        worksheet.write(2,p*25+15,'EE2_2D [mum/mum]',horizontalpathsstringFormat)
                        worksheet.write(2,p*25+16,'EEmises_3D [mum/mum]',horizontalpathsstringFormat)
                        worksheet.write(2,p*25+17,'EEmises_2D [mum/mum]',horizontalpathsstringFormat)
                        worksheet.write(2,p*25+18,'EEaverage_3D [mum/mum]',horizontalpathsstringFormat)
                        worksheet.write(2,p*25+19,'EEaverage_2D [mum/mum]',horizontalpathsstringFormat)
                        worksheet.write(2,p*25+20,'EEI1_3D [mum/mum]',horizontalpathsstringFormat)
                        worksheet.write(2,p*25+21,'EEI2_3D [(mum/mum)^2]',horizontalpathsstringFormat)
                        worksheet.write(2,p*25+22,'EEI3_3D [(mum/mum)^3]',horizontalpathsstringFormat)
                        worksheet.write(2,p*25+23,'EEI1_2D [mum/mum]',horizontalpathsstringFormat)
                        worksheet.write(2,p*25+24,'EEI2_2D [(mum/mum)^2]',horizontalpathsstringFormat)
                        measureNum = np.min([len(Sxx[p]),len(Syy[p]),len(Szz[p]),len(Sxy[p])])
                        print('          number of path points = ' + str(measureNum))
                        for c in range(0,measureNum):
                            coord = pathCoords[p][c]
                            worksheet.write(3+c,p*25,coord,horizontalpathsnumberFormat)
                            worksheet.write(3+c,p*25+1,pathNormCoords[p][c],horizontalpathsnumberFormat)
                            worksheet.write(3+c,p*25+2,EExx[p][c],horizontalpathsnumberFormat)
                            worksheet.write(3+c,p*25+3,EEyy[p][c],horizontalpathsnumberFormat)
                            worksheet.write(3+c,p*25+4,EEzz[p][c],horizontalpathsnumberFormat)
                            worksheet.write(3+c,p*25+5,EExy[p][c],horizontalpathsnumberFormat)
                            worksheet.write(3+c,p*25+6,0.0,horizontalpathsnumberFormat)
                            worksheet.write(3+c,p*25+7,0.0,horizontalpathsnumberFormat)
                            worksheet.write(3+c,p*25+8,EErr[p][c],horizontalpathsnumberFormat)
                            worksheet.write(3+c,p*25+9,EEtt[p][c],horizontalpathsnumberFormat)
                            worksheet.write(3+c,p*25+10,EErt[p][c],horizontalpathsnumberFormat)
                            worksheet.write(3+c,p*25+11,EE1D3[p][c],horizontalpathsnumberFormat)
                            worksheet.write(3+c,p*25+12,EE2D3[p][c],horizontalpathsnumberFormat)
                            worksheet.write(3+c,p*25+13,EE3D3[p][c],horizontalpathsnumberFormat)
                            worksheet.write(3+c,p*25+14,EE1D2[p][c],horizontalpathsnumberFormat)
                            worksheet.write(3+c,p*25+15,EE2D2[p][c],horizontalpathsnumberFormat)
                            worksheet.write(3+c,p*25+16,EEMisesD3[p][c],horizontalpathsnumberFormat)
                            worksheet.write(3+c,p*25+17,EEMisesD2[p][c],horizontalpathsnumberFormat)
                            worksheet.write(3+c,p*25+18,EEaverD3[p][c],horizontalpathsnumberFormat)
                            worksheet.write(3+c,p*25+19,EEaverD2[p][c],horizontalpathsnumberFormat)
                            worksheet.write(3+c,p*25+20,EEI1D3[p][c],horizontalpathsnumberFormat)
                            worksheet.write(3+c,p*25+21,EEI2D3[p][c],horizontalpathsnumberFormat)
                            worksheet.write(3+c,p*25+22,EEI3D3[p][c],horizontalpathsnumberFormat)
                            worksheet.write(3+c,p*25+23,EEI1D2[p][c],horizontalpathsnumberFormat)
                            worksheet.write(3+c,p*25+24,EEI2D2[p][c],horizontalpathsnumberFormat)
                ...
                if subFolder.split('/')[-1] + '-strainsverticalpaths' + '.csv' in listdir(subFolder):
                    ...
                    for p, pathVariable in enumerate(pathVariables):
                        ...
                        worksheet.write(2,p*25,pathCoordinateName,verticalpathsstringFormat)
                        worksheet.write(2,p*25+1,'Norm ' + pathCoordinateName,verticalpathsstringFormat)
                        worksheet.write(2,p*25+2,'EExx [mum/mum]',verticalpathsstringFormat)
                        worksheet.write(2,p*25+3,'EEyy [mum/mum]',verticalpathsstringFormat)
                        worksheet.write(2,p*25+4,'EEzz [mum/mum]',verticalpathsstringFormat)
                        worksheet.write(2,p*25+5,'EExy [mum/mum]',verticalpathsstringFormat)
                        worksheet.write(2,p*25+6,'EEzx [mum/mum]',verticalpathsstringFormat)
                        worksheet.write(2,p*25+7,'EEyz [mum/mum]',verticalpathsstringFormat)
                        worksheet.write(2,p*25+8,'EErr [mum/mum]',verticalpathsstringFormat)
                        worksheet.write(2,p*25+9,'EEtt [mum/mum]',verticalpathsstringFormat)
                        worksheet.write(2,p*25+10,'EErt [mum/mum]',verticalpathsstringFormat)
                        worksheet.write(2,p*25+11,'EE1_3D [mum/mum]',verticalpathsstringFormat)
                        worksheet.write(2,p*25+12,'EE2_3D [mum/mum]',verticalpathsstringFormat)
                        worksheet.write(2,p*25+13,'EE3_3D [mum/mum]',verticalpathsstringFormat)
                        worksheet.write(2,p*25+14,'EE1_2D [mum/mum]',verticalpathsstringFormat)
                        worksheet.write(2,p*25+15,'EE2_2D [mum/mum]',verticalpathsstringFormat)
                        worksheet.write(2,p*25+16,'EEmises_3D [mum/mum]',verticalpathsstringFormat)
                        worksheet.write(2,p*25+17,'EEmises_2D [mum/mum]',verticalpathsstringFormat)
                        worksheet.write(2,p*25+18,'EEaverage_3D [mum/mum]',verticalpathsstringFormat)
                        worksheet.write(2,p*25+19,'EEaverage_2D [mum/mum]',verticalpathsstringFormat)
                        worksheet.write(2,p*25+20,'EEI1_3D [mum/mum]',verticalpathsstringFormat)
                        worksheet.write(2,p*25+21,'EEI2_3D [(mum/mum)^2]',verticalpathsstringFormat)
                        worksheet.write(2,p*25+22,'EEI3_3D [mum/mum^3]',verticalpathsstringFormat)
                        worksheet.write(2,p*25+23,'EEI1_2D [(mum/mum)]',verticalpathsstringFormat)
                        worksheet.write(2,p*25+24,'EEI2_2D [(mum/mum)^2]',verticalpathsstringFormat)
                        measureNum = np.min([len(Sxx[p]),len(Syy[p]),len(Szz[p]),len(Sxy[p])])
                        print('          number of path points = ' + str(measureNum))
                        for c in range(0,measureNum):
                            coord = pathCoords[p][c]
                            worksheet.write(3+c,p*25,coord,verticalpathsnumberFormat)
                            worksheet.write(3+c,p*25+1,pathNormCoords[p][c],verticalpathsnumberFormat)
                            worksheet.write(3+c,p*25+2,EExx[p][c],verticalpathsnumberFormat)
                            worksheet.write(3+c,p*25+3,EEyy[p][c],verticalpathsnumberFormat)
                            worksheet.write(3+c,p*25+4,EEzz[p][c],verticalpathsnumberFormat)
                            worksheet.write(3+c,p*25+5,EExy[p][c],verticalpathsnumberFormat)
                            worksheet.write(3+c,p*25+6,0.0,verticalpathsnumberFormat)
                            worksheet.write(3+c,p*25+7,0.0,verticalpathsnumberFormat)
                            worksheet.write(3+c,p*25+8,EErr[p][c],verticalpathsnumberFormat)
                            worksheet.write(3+c,p*25+9,EEtt[p][c],verticalpathsnumberFormat)
                            worksheet.write(3+c,p*25+10,EErt[p][c],verticalpathsnumberFormat)
                            worksheet.write(3+c,p*25+11,EE1D3[p][c],verticalpathsnumberFormat)
                            worksheet.write(3+c,p*25+12,EE2D3[p][c],verticalpathsnumberFormat)
                            worksheet.write(3+c,p*25+13,EE3D3[p][c],verticalpathsnumberFormat)
                            worksheet.write(3+c,p*25+14,EE1D2[p][c],verticalpathsnumberFormat)
                            worksheet.write(3+c,p*25+15,EE2D2[p][c],verticalpathsnumberFormat)
                            worksheet.write(3+c,p*25+16,EEMisesD3[p][c],verticalpathsnumberFormat)
                            worksheet.write(3+c,p*25+17,EEMisesD2[p][c],verticalpathsnumberFormat)
                            worksheet.write(3+c,p*25+18,EEaverD3[p][c],verticalpathsnumberFormat)
                            worksheet.write(3+c,p*25+19,EEaverD2[p][c],verticalpathsnumberFormat)
                            worksheet.write(3+c,p*25+20,EEI1D3[p][c],verticalpathsnumberFormat)
                            worksheet.write(3+c,p*25+21,EEI2D3[p][c],verticalpathsnumberFormat)
                            worksheet.write(3+c,p*25+22,EEI3D3[p][c],verticalpathsnumberFormat)
                            worksheet.write(3+c,p*25+23,EEI1D2[p][c],verticalpathsnumberFormat)
                            worksheet.write(3+c,p*25+24,EEI2D2[p][c],verticalpathsnumberFormat)
