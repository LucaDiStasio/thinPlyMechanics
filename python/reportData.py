            ...
            for subFolder in subfoldersList:
                ...
                if subFolder.split('/')[-1] + '-stressesradialpaths' + '.csv' in listdir(subFolder):
                    ...
                    for p, pathVariable in enumerate(pathVariables):
                        ...
                        worksheet.write(2,p*25+3,'Sxx [MPa]',stringFormat)
                        worksheet.write(2,p*25+4,'Sxx [MPa]',stringFormat)
                        worksheet.write(2,p*25+5,'Sxx [MPa]',stringFormat)
                        worksheet.write(2,p*25+6,'Sxx [MPa]',stringFormat)
                        worksheet.write(2,p*25+7,'Sxx [MPa]',stringFormat)
                        worksheet.write(2,p*25+8,'Sxx [MPa]',stringFormat)
                        worksheet.write(2,p*25+9,'Sxx [MPa]',stringFormat)
                        worksheet.write(2,p*25+10,'Sxx [MPa]',stringFormat)
                        worksheet.write(2,p*25+11,'Sxx [MPa]',stringFormat)
                        worksheet.write(2,p*25+12,'Sxx [MPa]',stringFormat)
                        worksheet.write(2,p*25+13,'Sxx [MPa]',stringFormat)
                        worksheet.write(2,p*25+14,'Sxx [MPa]',stringFormat)
                        worksheet.write(2,p*25+15,'Sxx [MPa]',stringFormat)
                        worksheet.write(2,p*25+16,'Sxx [MPa]',stringFormat)
                        worksheet.write(2,p*25+17,'Sxx [MPa]',stringFormat)
                        worksheet.write(2,p*25+18,'Sxx [MPa]',stringFormat)
                        worksheet.write(2,p*25+19,'Sxx [MPa]',stringFormat)
                        worksheet.write(2,p*25+20,'Sxx [MPa]',stringFormat)
                        worksheet.write(2,p*25+21,'Sxx [MPa]',stringFormat)
                        worksheet.write(2,p*25+22,'Sxx [MPa]',stringFormat)
                        worksheet.write(2,p*25+23,'Sxx [MPa]',stringFormat)
