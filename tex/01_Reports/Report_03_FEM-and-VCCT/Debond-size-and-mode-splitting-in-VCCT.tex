...
&=\frac{1}{2R_{f}\delta}\sum_{p=1}^{m+1}\sum_{q=1}^{m+1}Tr\left(\underline{F}_{r\theta}\underline{u}_{r\theta}^{T}\right)=\frac{1}{2R_{f}\delta}\sum_{p=1}^{m+1}\sum_{q=1}^{m+1}Tr\left(\begin{bmatrix}
F_{r,q}u_{r,p}&F_{r,q}u_{\theta,p}\\
F_{\theta,q}u_{r,p}&F_{\theta,q}u_{\theta,p}\\
\end{bmatrix}\right)=\\
&=\frac{1}{2R_{f}\delta}\sum_{p=1}^{m+1}\sum_{q=1}^{m+1}Tr\left(\underline{\underline{R}}_{\Delta\theta}\underline{F}_{xy,q}\underline{u}_{xy,p}^{T}\underline{\underline{R}}_{\Delta\theta}^{T}\underline{\underline{R}}_{\delta}^{T}\right)
\end{split}
\end{equation}
