...
= &\frac{1}{2R_{f}\delta}\left(-\sin\left(\Delta\theta\right) F_{x}+\cos\left(\Delta\theta\right)F_{y}\right)\left(-\left(-\cos\left(\Delta\theta\right)\sin\left(\delta\right)\right)u_{x}+\left(\sin\left(\Delta\theta\right)\sin\left(\delta\right)\right)u_{y}\right)=\\
