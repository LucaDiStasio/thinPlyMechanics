...
\begin{equation}
\begin{cases}
\frac{\partial N_{1}\left(\xi,\eta\right)}{\partial \xi}=\frac{1}{4}\left(1-\xi\right)\left(1-\eta\right)\left(-\xi-\eta-1\right)\\
\frac{\partial N_{2}\left(\xi,\eta\right)}{\partial \xi}=\frac{1}{4}\left(1+\xi\right)\left(1-\eta\right)\left(\xi-\eta-1\right)\\
\frac{\partial N_{3}\left(\xi,\eta\right)}{\partial \xi}=\frac{1}{4}\left(1+\xi\right)\left(1+\eta\right)\left(\xi+\eta-1\right)\\
\frac{\partial N_{4}\left(\xi,\eta\right)}{\partial \xi}=\frac{1}{4}\left(1-\xi\right)\left(1+\eta\right)\left(-\xi+\eta-1\right)\\
\frac{\partial N_{5}\left(\xi,\eta\right)}{\partial \xi}=\frac{1}{2}\left(1-\xi^{2}\right)\left(1-\eta\right)\\
\frac{\partial N_{6}\left(\xi,\eta\right)}{\partial \xi}=\frac{1}{2}\left(1+\xi\right)\left(1-\eta^{2}\right)\\
\frac{\partial N_{7}\left(\xi,\eta\right)}{\partial \xi}=\frac{1}{2}\left(1-\xi^{2}\right)\left(1+\eta\right)\\
\frac{\partial N_{8}\left(\xi,\eta\right)}{\partial \xi}=\frac{1}{2}\left(1-\xi\right)\left(1-\eta^{2}\right)\\
\frac{\partial N_{1}\left(\xi,\eta\right)}{\partial \eta}=\frac{1}{4}\left(1-\xi\right)\left(1-\eta\right)\left(-\xi-\eta-1\right)\\
\frac{\partial N_{2}\left(\xi,\eta\right)}{\partial \eta}=\frac{1}{4}\left(1+\xi\right)\left(1-\eta\right)\left(\xi-\eta-1\right)\\
\frac{\partial N_{3}\left(\xi,\eta\right)}{\partial \eta}=\frac{1}{4}\left(1+\xi\right)\left(1+\eta\right)\left(\xi+\eta-1\right)\\
\frac{\partial N_{4}\left(\xi,\eta\right)}{\partial \eta}=\frac{1}{4}\left(1-\xi\right)\left(1+\eta\right)\left(-\xi+\eta-1\right)\\
\frac{\partial N_{5}\left(\xi,\eta\right)}{\partial \eta}=\frac{1}{2}\left(1-\xi^{2}\right)\left(1-\eta\right)\\
\frac{\partial N_{6}\left(\xi,\eta\right)}{\partial \eta}=\frac{1}{2}\left(1+\xi\right)\left(1-\eta^{2}\right)\\
\frac{\partial N_{7}\left(\xi,\eta\right)}{\partial \eta}=\frac{1}{2}\left(1-\xi^{2}\right)\left(1+\eta\right)\\
\frac{\partial N_{8}\left(\xi,\eta\right)}{\partial \eta}=\frac{1}{2}\left(1-\xi\right)\left(1-\eta^{2}\right)\\
\end{cases}
\end{equation}
...
\frac{\partial N_{2}\left(\xi,\eta\right)}{\partial x}=\frac{1}{4}\left(1+\xi\right)\left(1-\eta\right)\\
\frac{\partial N_{3}\left(\xi,\eta\right)}{\partial x}=\frac{1}{4}\left(1+\xi\right)\left(1+\eta\right)\\
\frac{\partial N_{4}\left(\xi,\eta\right)}{\partial x}=\frac{1}{4}\left(1-\xi\right)\left(1+\eta\right)\\
\frac{\partial N_{1}\left(\xi,\eta\right)}{\partial y}=\frac{1}{4}\left(1-\xi\right)\left(1-\eta\right)\\
\frac{\partial N_{2}\left(\xi,\eta\right)}{\partial y}=\frac{1}{4}\left(1+\xi\right)\left(1-\eta\right)\\
\frac{\partial N_{3}\left(\xi,\eta\right)}{\partial y}=\frac{1}{4}\left(1+\xi\right)\left(1+\eta\right)\\
\frac{\partial N_{4}\left(\xi,\eta\right)}{\partial y}=\frac{1}{4}\left(1-\xi\right)\left(1+\eta\right)\\
\end{cases}
\end{equation}
