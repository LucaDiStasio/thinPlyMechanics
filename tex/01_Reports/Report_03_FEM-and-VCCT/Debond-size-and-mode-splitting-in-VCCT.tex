...
&\left(k_{e,F|11}+k_{e,F|33}\right)u_{x,FCT}+\left(k_{e,F|12}+k_{e,F|34}\right)u_{y,FCT}+\\&+k_{e,F|13}u_{x,M}+k_{e,F|14}u_{y,M}+\left(k_{F|17}+k_{F|35}\right)u_{N,MC|7}+\left(k_{F|18}+k_{F|36}\right)u_{N,MC|8}+\\&+\sum_{i=5}^{6}k_{F|1i}u_{N,MC|i}+\sum_{i=7}^{8}k_{F|3i}u_{N,MB|i}+k_{F|31}u_{x,NCOI}+k_{F|32}u_{y,NCOI}=0\\[10pt]
&\left(k_{e,F|21}+k_{e,F|43}\right)u_{x,FCT}+\left(k_{e,F|22}+k_{e,F|44}\right)u_{y,FCT}+\\&+k_{e,F|23}u_{x,M}+k_{e,F|24}u_{y,M}+\left(k_{F|27}+k_{F|45}\right)u_{N,MC|7}+\left(k_{F|28}+k_{F|46}\right)u_{N,MC|8}+\\&+\sum_{i=5}^{6}k_{F|2i}u_{N,MC|i}+\sum_{i=7}^{8}k_{F|4i}u_{N,MB|i}+k_{F|41}u_{x,NCOI}+k_{F|42}u_{y,NCOI}=0\\[10pt]
