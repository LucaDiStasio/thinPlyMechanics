...
&\left(k_{e,MC|11}+k_{e,MB|33}\right)u_{x,MCT}+\left(k_{e,MC|22}+k_{e,MB|44}\right)u_{y,MCT}+\\&+k_{e,MC|13}u_{x,MCDM}+k_{e,MC|14}u_{y,MCDM}+\\&+k_{e,MC|15}u_{x,MCNE}+k_{e,MC|16}u_{y,MCNE}+k_{e,MC|17}u_{x,MCNW}+k_{e,MC|18}u_{y,MCNW}+\\
&+k_{e,MB|13}u_{x,MBCO}+k_{e,MB|23}u_{y,MBCO}+\\&+k_{e,MB|35}u_{x,MBNE}+k_{e,MB|36}u_{y,MBNE}+k_{e,MB|37}u_{x,MBNW}+k_{e,MB|38}u_{y,MBNW}=0\\
&u_{x,DUMMY}=0\\
&u_{y,DUMMY}=0\\
\end{cases}
