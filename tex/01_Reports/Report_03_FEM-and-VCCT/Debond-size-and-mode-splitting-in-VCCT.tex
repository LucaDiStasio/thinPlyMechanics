...
&u_{x,FCT}=u_{x,MCT}\\
&u_{y,FCT}=u_{y,MCT}\\[10pt]
&F_{x,CT}&=R_{x,FCT}=\\&=\left(k_{e,F|77}+k_{e,F|55}\right)k_{e,M}u_{x,FCT}+\left(k_{e,F|78}+k_{e,F|56}\right)k_{e,M}u_{y,FCT}\\
&F_{y,CT}&=R_{y,FCT}=\\&=\left(k_{e,F|87}+k_{e,F|65}\right)k_{e,M}u_{x,FCT}+\left(k_{e,F|88}+k_{e,F|66}\right)k_{e,M}u_{y,FCT}\\
\end{cases}
\end{equation}
