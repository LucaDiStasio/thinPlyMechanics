...
\begin{abstract}
The effect of debond size and crack tip orientation of mode splitting in the Virtual Crack Closure Technique is analyzed by means of analytical derivations. It is shonw that:
\begin{enumerate}
\item The total energy release rate is shown to have no direct dependence on the debond angular size, but only an indirect one through the FEM solution of the crack displacement field in the crack tip neighbourhood.
\end{enumerate}
\end{abstract}
...
\bibitem{Williams:1959}CWilliams, M. L. 1959 he Stresses Around a Fault or Crack in Dissimilar Media {\it B. Seismol. Soc. Am.}{\bf 49}(2)
