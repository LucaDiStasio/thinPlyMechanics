...
\begin{equation}
\begin{split}
F_{r}u_{\theta}=&\int_{0}^{\delta}\sigma_{r}\left(s\right)u_{\theta}\left(s\right)ds\\
F_{\theta}u_{r}=&\int_{0}^{\delta}\sigma_{\theta}\left(s\right)u_{r}\left(s\right)ds\\
\end{split}
\end{equation}
...
&=\frac{1}{2R_{f}\delta}Tr\left(\underline{\underline{R}}_{\Delta\theta}\left(\underline{\underline{K}}_{xy}\underline{u}_{xy}+\underline{\widetilde{F}}_{xy}\right)\underline{u}_{xy}^{T}\underline{\underline{R}}_{\Delta\theta}^{T}\underline{\underline{R}}_{\delta}^{T}\right)=\\
&=\frac{1}{2R_{f}\delta}Tr\left(\underline{\underline{R}}_{\Delta\theta}\left(\underline{\underline{K}}_{xy}\underline{u}_{xy}\right)\underline{u}_{xy}^{T}\underline{\underline{R}}_{\Delta\theta}^{T}\underline{\underline{R}}_{\delta}^{T}\right)+\frac{1}{2R_{f}\delta}Tr\left(\underline{\underline{R}}_{\Delta\theta}\left(\underline{\widetilde{F}}_{xy}\right)\underline{u}_{xy}^{T}\underline{\underline{R}}_{\Delta\theta}^{T}\underline{\underline{R}}_{\delta}^{T}\right)=\\
\end{split}
\end{equation}
