...
= &\frac{1}{2R_{f}\delta}\left(-\sin\left(\Delta\theta\right) F_{x}+\cos\left(\Delta\theta\right)F_{y}\right)\left(-\left(\sin\left(\Delta\theta\right)\cos\left(\delta\right)-\cos\left(\Delta\theta\right)\sin\left(\delta\right)\right)u_{x}+\left(\cos\left(\Delta\theta\right)\cos\left(\delta\right)+\sin\left(\Delta\theta\right)\sin\left(\delta\right)\right)u_{y}\right)=\\
= &\frac{1}{2R_{f}\delta}\left(\sin^{2}\left(\Delta\theta\right) F_{x}u_{x}-\left(F_{x}u_{y}+F_{y}u_{x}\right)\cos\left(\Delta\theta\right)\sin\left(\Delta\theta\right)+\cos^{2}\left(\Delta\theta\right)F_{y}u_{y}\right)\\
\end{split}
\end{equation}
