...
\begin{equation}
\begin{cases}
F_{x,CT}&\sim K_{xx}u_{x}+K_{xy}u_{y}+\\
&+\sum_{i=1}^{4}K_{FC,i}u_{N,FC|i}+\sum_{i=1,i\neq\left(3,4,5,6\right)}^{8}K_{FB,i}u_{N,FB|i}+\\
&+\sum_{i=5}^{8}K_{FC,i}u_{N,MC|i}+\sum_{i=7}^{8}K_{MB,i}u_{N,FB|i}\\
F_{y,CT}&\sim K_{yx}u_{x}+K_{yy}u_{y}+\\
&+\sum_{i=1}^{4}k_{e,F|8i}u_{N,FC|i}+\sum_{i=1,i\neq\left(5,6\right)}^{8}k_{e,F|6i}u_{N,FB|i}\\
\end{cases}
\end{equation}
