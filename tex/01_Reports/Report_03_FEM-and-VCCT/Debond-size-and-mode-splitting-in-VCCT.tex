...
=&\int_{-1}^{1}\int_{-1}^{1}\left(\underline{\underline{B}}^{T}\underline{\underline{D}}\cdot\underline{\underline{B}}\right)\sqrt{g}d\xi d\eta\approx \sum_{i=1}^{N}\sum_{j=1}^{N}w_{i}w_{j}\underline{\underline{B}}^{T}\underline{\underline{D}}\cdot\underline{\underline{B}}\left(\xi,\eta\right)
\end{split}
\end{equation}
