...
\begin{equation}
\begin{cases}
&\left(k_{e,MC|11}+k_{e,MB|33}\right)u_{x,MCT}+\left(k_{e,MC|12}+k_{e,MB|34}\right)u_{y,MCT}+\\&+k_{e,MC|13}u_{x,MCDM}+k_{e,MC|14}u_{y,MCDM}+\\&+k_{e,MC|15}u_{x,MCNE}+k_{e,MC|16}u_{y,MCNE}+k_{e,MC|17}u_{x,MCNW}+k_{e,MC|18}u_{y,MCNW}+\\
&+k_{e,MB|13}u_{x,MBCO}+k_{e,MB|23}u_{y,MBCO}+\\&+k_{e,MB|35}u_{x,MBNE}+k_{e,MB|36}u_{y,MBNE}+k_{e,MB|37}u_{x,MBNW}+k_{e,MB|38}u_{y,MBNW}=0\\
&\left(k_{e,MC|21}+k_{e,MB|43}\right)u_{x,MCT}+\left(k_{e,MC|22}+k_{e,MB|44}\right)u_{y,MCT}+\\&+k_{e,MC|23}u_{x,MCDM}+k_{e,MC|24}u_{y,MCDM}+\\&+k_{e,MC|25}u_{x,MCNE}+k_{e,MC|26}u_{y,MCNE}+k_{e,MC|27}u_{x,MCNW}+k_{e,MC|28}u_{y,MCNW}+\\
&+k_{e,MB|43}u_{x,MBCO}+k_{e,MB|43}u_{y,MBCO}+\\&+k_{e,MB|45}u_{x,MBNE}+k_{e,MB|46}u_{y,MBNE}+k_{e,MB|47}u_{x,MBNW}+k_{e,MB|48}u_{y,MBNW}=0\\
&u_{x,FCT}-u_{x,MCT}-u_{x,DUMMY}=0\\
&u_{y,FCT}-u_{y,MCT}-u_{y,DUMMY}=0\\
&u_{x,DUMMY}=0\\
&u_{y,DUMMY}=0\\
\end{cases}
\end{equation}
...
\begin{equation}
\begin{cases}
&\left(k_{e,M|11}+k_{e,M|33}\right)u_{x,MCT}+\left(k_{e,M|12}+k_{e,M|34}\right)u_{y,MCT}+\\&+k_{e,M|13}u_{x,M}+k_{e,M|14}u_{y,M}+\left(k_{M|17}+k_{M|35}\right)u_{N,MC|7}+\left(k_{M|18}+k_{M|36}\right)u_{N,MC|8}+\\&+\sum_{i=5}^{6}k_{M|1i}u_{N,MC|i}+\sum_{i=7}^{8}k_{M|3i}u_{N,MB|i}+k_{M|31}u_{x,NCOI}+k_{M|32}u_{y,NCOI}=0\\
&\left(k_{e,M|21}+k_{e,M|43}\right)u_{x,MCT}+\left(k_{e,M|22}+k_{e,M|44}\right)u_{y,MCT}+\\&+k_{e,M|23}u_{x,M}+k_{e,M|24}u_{y,M}+\left(k_{M|27}+k_{M|45}\right)u_{N,MC|7}+\left(k_{M|28}+k_{M|46}\right)u_{N,MC|8}+\\&+\sum_{i=5}^{6}k_{M|2i}u_{N,MC|i}+\sum_{i=7}^{8}k_{M|4i}u_{N,MB|i}+k_{M|41}u_{x,NCOI}+k_{M|42}u_{y,NCOI}=0\\
&\left(k_{e,M|21}+k_{e,M|43}\right)u_{x,MCT}+\left(k_{e,M|22}+k_{e,M|44}\right)u_{y,MCT}+\\&+k_{e,M|23}u_{x,MCDM}+k_{e,M|24}u_{y,MCDM}+\\&+k_{e,M|25}u_{x,MCNE}+k_{e,MC|26}u_{y,MCNE}+k_{e,M|27}u_{x,MCNW}+k_{e,M|28}u_{y,MCNW}+\\
&+k_{e,M|43}u_{x,MBCO}+k_{e,M|43}u_{y,MBCO}+\\&+k_{e,M|45}u_{x,MBNE}+k_{e,M|46}u_{y,MBNE}+k_{e,M|47}u_{x,MBNW}+k_{e,M|48}u_{y,MBNW}=0\\
&u_{x,FCT}-u_{x,MCT}-u_{x,DUMMY}=0\\
&u_{y,FCT}-u_{y,MCT}-u_{y,DUMMY}=0\\
&u_{x,DUMMY}=0\\
&u_{y,DUMMY}=0\\
