...
=&G_{TOT,r\theta}\cos\left(\delta\right)+
\end{split}
\end{equation}
...
= &G_{TOT,r\theta}+\frac{1}{2R_{f}}\left(F_{y}u_{x}-F_{x}u_{y}\right)\lim_{\delta\rightarrow 0}\frac{\sin\left(\delta\right)}{\delta}\\
...
\begin{equation}
\begin{split}
F_{r}u_{\theta}=&\int_{0}^{\delta}\sigma_{r}u_{\theta}\left(\right)\\
F_{r}u_{\theta}=&\int_{0}^{\delta}\sigma_{r}u_{\theta}\left(\right)\\
\end{split}
\end{equation}
