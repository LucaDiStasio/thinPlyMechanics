...
\begin{equation}
\underline{F}_{xy}=\underline{\underline{K}}\cdot\underline{u}_{xy}+\underline{\widetilde{F}}_{xy}
\end{equation}
...
&=\frac{1}{2R_{f}\delta}Tr\left(\underline{\underline{R}}_{\Delta\theta}\left(\underline{\underline{K}}\cdot\underline{u}_{xy}+\underline{\widetilde{F}}_{xy}\right)\underline{u}_{xy}^{T}\underline{\underline{R}}_{\Delta\theta}^{T}\underline{\underline{R}}_{\delta}^{T}\right)=\\
\end{split}
\end{equation}
