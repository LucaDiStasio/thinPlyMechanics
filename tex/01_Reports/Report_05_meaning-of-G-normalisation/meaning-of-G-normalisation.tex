...
\frac{G_{I}}{G_{TOT}}&\approx 1, \frac{G_{I}}{G_{0}}\sim\sqrt{\sec{\left(\frac{\pi}{2}\frac{R_{f}\Delta\theta}{t_{k}}\right)}}\left(1-0.025\left(\frac{R_{f}\Delta\theta}{t_{k}}\right)^{2}+0.06\left(\frac{R_{f}\Delta\theta}{t_{k}}\right)^{4}\right)\\&or\ \sim\sqrt{\sec{\left(\frac{\pi}{2}\frac{a}{t_{k}}\right)}}\left(1-0.025\left(\frac{a}{t_{k}}\right)^{2}+0.06\left(\frac{a}{t_{k}}\right)^{4}\right)\quad 2t_{k}=\text{\small ply thickness}\\ &\rightarrow\text{\scriptsize the crack (debond or transverse) $\sim$ a transverse central crack in a finite size plate}\\
...
\frac{G_{I}}{G_{TOT}}&< 1, \frac{G_{TOT}}{G_{0}}\sim\sqrt{\sec{\left(\frac{\pi}{2}\frac{R_{f}\Delta\theta}{t_{k}}\right)}}\left(1-0.025\left(\frac{R_{f}\Delta\theta}{t_{k}}\right)^{2}+0.06\left(\frac{R_{f}\Delta\theta}{t_{k}}\right)^{4}\right)\\&or\ \sim\sqrt{\sec{\left(\frac{\pi}{2}\frac{a}{t_{k}}\right)}}\left(1-0.025\left(\frac{a}{t_{k}}\right)^{2}+0.06\left(\frac{a}{t_{k}}\right)^{4}\right)\quad 2t_{k}=\text{\small ply thickness}\\ &\rightarrow\text{\scriptsize  global ERR $\sim$ a transverse central crack in a finite size plate, but mode ratio is different}\\
\end{cases}
\end{equation}
