...
\frac{G_{I}}{G_{TOT}}&\approx 1, \frac{G_{I}}{G_{0}}\sim\sqrt{\sec{\frac{\pi}{2}\frac{R_{f}\Delta\theta}{t_{k}}}}\ or\ \sim\sqrt{\sec{\frac{\pi}{2}\frac{a}{t_{k}}}}\qquad 2t_{k}=\text{\small ply thickness}\\ &\rightarrow\text{\scriptsize the crack (debond or transverse) $\sim$ a transverse central crack in a finite size plate}\\
\end{cases}
\end{equation}
