...
\begin{equation}
\begin{split}
G_{0}&=\frac{\sigma_{0}^{2}}{E^{*}}\pi R_{f}\text{for a stress or force controlled test}\\
G_{0}&=E^{*}\varepsilon_{0}^{2}\pi R_{f}\text{for a strain or displacement controlled test}
\end{split}
\end{equation}
