...
\begin{equation}
p\left(\Delta\theta\right)=p\left(\Delta\theta|\varepsilon\right)\sim\frac{1}{\sqrt{2\pi}\sigma_{\Delta\theta}\left(\varepsilon\right)}e^{\left(\frac{\Delta\theta-\overline{\Delta\theta}}{\sigma_{\Delta\theta}}\right)}
\end{equation}
