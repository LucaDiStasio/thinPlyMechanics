...
\begin{frame}
\frametitle{Visual Definition of Transverse Cracking}
\vspace{-0.75cm}
\centering
...
\subsection[Performances]{Numerical performances}
...
\begin{figure}[!h]
\centering
\subfloat{\includegraphics[height=0.5\textheight]{SingleRVEs.pdf}}\quad
\subfloat{\includegraphics[height=0.5\textheight]{boundedRVE_cc.pdf}}\quad
\subfloat{\includegraphics[height=0.5\textheight]{periodicRVE_cc.pdf}}
  %\caption{Single RVE model.}
