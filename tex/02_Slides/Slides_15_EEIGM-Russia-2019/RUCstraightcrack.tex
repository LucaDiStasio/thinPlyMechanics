...
\draw [red,line width=2.5mm] (\starteq,0) -- (\starteq,\sinthetaupcz*\Rf);
\draw (\starteq+0.1,0.5*\sinthetaupcz*\Rf) node[red,right] {\Huge$\mathbf{\sin{\Delta\theta}}$};

\draw (\starteq+1.15*\Rf,1.15*\Rf) node[black,above] {\Huge$\mathbf{\Omega_{C}}$};

\draw (\starteq-0.15,0.0) node[black,left,above] {\Huge$O$};
