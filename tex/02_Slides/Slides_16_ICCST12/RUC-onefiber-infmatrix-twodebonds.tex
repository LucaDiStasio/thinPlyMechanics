...
\begin{scope}[style=axes]
  \draw[->,line width=0.75mm] (-0.75*\symmsyml-\symmsymh,0) -- (0.5*\symmsyml+\symmsymh+1.15*\loadlim,0) node[right] {\Huge$x$};
...
\draw[line width=1.25mm] (\costhetaupcz,\sinthetaupcz)arc (50:90:\Rf);
...
\draw[line width=1.25mm] (0,0) -- (0,\l);

\draw[line width=1.25mm] (0,\l) -- (\l,\l) ;

\draw[line width=1.25mm] (\l,0) -- (\l,\l) ;
\draw[line width=1.25mm] (0,0) -- (\l,0) ;

\draw[dashed,blue,line width=0.75mm] (0,-1.5*\symmsyml-\symmsymh) -- (\l,-1.5*\symmsyml-\symmsymh);
...
\draw[dashed,blue,line width=0.75mm] (-1,0) -- (-1,\l);
\draw[dashed,blue,line width=0.75mm] (-1-0.5*\symmsyml,0) -- (-1+0.5*\symmsyml,0);
\draw[dashed,blue,line width=0.75mm] (-1-0.5*\symmsyml,\l) -- (-1+0.5*\symmsyml,\l);

\draw (-1,0.5*\l) node[blue,left] {\Huge$L$};
\draw (0.5*\l,-1.5*\symmsyml-\symmsymh) node[blue,below] {\Huge$L$};

\draw (0.5*\symmsyml+\symmsymh+\l,1.1*\l) node[black,right] {\Huge$+\sigma_{\infty}/+\varepsilon_{\infty}$};

\draw (0.35*\Rf,0.5*\Rf) node[black,above] {\Huge$\Omega_{f}$};
\draw (1.15*\Rf,1.15*\Rf) node[black,above] {\Huge$\Omega_{m}$};

\draw (0.25*\Rf*\cosfourtyfive,0.4*\Rf*\cosfourtyfive) node[black,left,above] {\Huge$R_{f}$};
\draw (-0.3,-0.25) node[black,left,below] {\Huge$O$};
...
%left symmetry
\foreach \x in {0,...,4}{
\draw[line width=1.25mm](0,\x*2*\symmsyml)--(0-\symmsymh,\x*2*\symmsyml-0.5*\symmsyml)--(0-\symmsymh,\x*2*\symmsyml+0.5*\symmsyml)--(0,\x*2*\symmsyml);
\draw[line width=1.25mm] (0-\symmsymh,\x*2*\symmsyml-0.25*\symmsyml,0)arc (0:360:0.25*\symmsyml);
\draw[line width=1.25mm] (0-\symmsymh,\x*2*\symmsyml+0.25*\symmsyml,0)arc (0:360:0.25*\symmsyml);}
