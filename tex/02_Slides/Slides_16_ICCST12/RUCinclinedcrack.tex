...
\draw[red,line width=2.5mm] (\starteq,0)--(\starteq+0.8*\costhetaupcz,0.8*\sinthetaupcz);
\draw (\starteq+1.3*\loadlim,-0.4) node[red,anchor=north east] {\Huge$\mathbf{f_{I}=\sin{\Delta\theta}\sin^{4}{\left(\frac{\pi}{2}-\Delta\theta\right)}, f_{II}=\sin{\Delta\theta}\sin^{2}{\left(\frac{\pi}{2}-\Delta\theta\right)}\cos^{2}{\left(\frac{\pi}{2}-\Delta\theta\right)}}$};
%\draw (\starteq,-0.8) node[red,below] {\Huge$\mathbf{f_{II}=\sin{\Delta\theta}\sin^{2}{\left(\frac{\pi}{2}-\Delta\theta\right)}\cos^{2}{\left(\frac{\pi}{2}-\Delta\theta\right)}}$};
