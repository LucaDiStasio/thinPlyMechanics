...
\begin{scope}[style=axes]
  \draw[->,line width=0.75mm] (-3.2*\l,0) -- (201.3*\l,0) node[right] {\Huge$x$};
  \draw[->,line width=0.75mm] (99*\l,-3.2*\l) -- (99*\l,3.3*\l) node[above] {\Huge$z$};
\end{scope}
...
\draw[line width=1.25mm] (-3*\l,3*\l) -- (201*\l,3*\l) ;
\draw[line width=1.25mm] (-3*\l,-3*\l) -- (201*\l,-3*\l) ;
\draw[line width=1.25mm] (201*\l,3*\l) -- (201*\l,-3*\l);
\draw[line width=1.25mm] (-3*\l,3*\l) -- (-3*\l,-3*\l);

\draw[->,line width=2.75mm] (202*\l,0) -- (203*\l,0) ;
\draw[above] (202.5*\l,0.5)node{\Huge$\varepsilon_{x}=1\%$};

\draw[->,line width=2.75mm] (-4*\l,0) -- (-5*\l,0) ;
\draw[below] (-4.5*\l,-0.5)node{\Huge$\varepsilon_{x}=1\%$};

\draw[below]  (99*\l,-3.5*\l)node{\Huge$\mathbf{11\times 1-asymm}$};
