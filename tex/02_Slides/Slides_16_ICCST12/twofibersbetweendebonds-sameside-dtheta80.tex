...
\begin{scope}[style=axes]
  \draw[->,line width=0.75mm] (-3.2*\l,0) -- (3.3*\l,0) node[right] {\Huge$x$};
  \draw[->,line width=0.75mm] (0,-4.2*\l) -- (0,4.3*\l) node[above] {\Huge$z$};
\end{scope}

\foreach \z in {-3,-1,1,3}{
\foreach \x in {0}{
% fully bonded fibers +/- 1
\draw[line width=1.25mm] (2*\l+\Rf,0+\x*2*\l+\z*\l,0)arc (0:360:\Rf);
\draw[line width=1.25mm] (-2*\l+\Rf,0+\x*2*\l+\z*\l,0)arc (0:360:\Rf);
}
}
...
\foreach \x in {0}{
% fully bonded fibers +/- 1
\draw[line width=1.25mm] (\Rf,0+\z*2*\l,0)arc (0:360:\Rf);
}
}

\foreach \z in {-0.75,0.75}{
\foreach \x in {0}{
 %debond on the right
...
\draw[line width=1.25mm] (-3*\l,4*\l) -- (3*\l,4*\l) ;
\draw[line width=1.25mm] (-3*\l,-4*\l) -- (3*\l,-4*\l) ;
\draw[line width=1.25mm] (3*\l,4*\l) -- (3*\l,-4*\l);
\draw[line width=1.25mm] (-3*\l,4*\l) -- (-3*\l,-4*\l);
...
\draw[below]  (0,-4.25*\l)node{\Huge$\mathbf{3\times 1-coupling}$};
