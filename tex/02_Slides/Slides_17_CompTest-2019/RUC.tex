...
%top symmetry
\foreach \x in {8,...,16}{
\draw[line width=1.25mm](-3*\l+\x*2*\symmsyml,\l)--(-3*\l+\x*2*\symmsyml-0.5*\symmsyml,\l+\symmsymh)--(-3*\l+\x*2*\symmsyml-0.5*\symmsyml+\symmsyml,\l+\symmsymh)--(-3*\l+\x*2*\symmsyml,\l);
\draw[line width=1.25mm] (-3*\l+\x*2*\symmsyml,\l+\symmsymh+0.25*\symmsyml,0)arc (0:360:0.25*\symmsyml);
\draw[line width=1.25mm] (-3*\l+\x*2*\symmsyml+0.5*\symmsyml,\l+\symmsymh+0.25*\symmsyml,0)arc (0:360:0.25*\symmsyml);}
