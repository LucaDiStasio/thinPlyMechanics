...
\foreach \z in {-1,0,1}{
\foreach \x in {0,1,3,4,6,7,9,10,12,13,15,16,18,19,21}{
\draw[line width=1.25mm] (\x*2*\l+\Rf,0+\z*2*\l,0)arc (0:360:\Rf);
}
}

\foreach \z in {-1,1}{
\foreach \x in {-1,2,5,8,11,14,17,20}{
\draw[line width=1.25mm] (\x*2*\l+\Rf,0+\z*2*\l,0)arc (0:360:\Rf);
...
\draw[line width=1.25mm] (-3*\l,-3*\l) -- (43*\l,-3*\l) ;
\draw[line width=1.25mm] (43*\l,3*\l) -- (43*\l,-3*\l);
...
\draw[below]  (20*\l,-3.5*\l)node{\Huge$\mathbf{3\times k-\cdots}$};
