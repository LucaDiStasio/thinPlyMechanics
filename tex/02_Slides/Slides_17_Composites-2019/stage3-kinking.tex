...
\draw[red,line width=1.25mm] (-\costhetaup,\sinthetaup+4*\l) -- (-\costhetaup,\sinthetaup+4.2*\l);
\draw[red,line width=1.25mm] (-\costhetaup,-\sinthetaup+4*\l) -- (-\costhetaup,-\sinthetaup+3.8*\l);

\draw[red,line width=1.25mm] (-\costhetaup,\sinthetaup+2*\l) -- (-\costhetaup,\sinthetaup+2.2*\l);
\draw[red,line width=1.25mm] (-\costhetaup,-\sinthetaup+2*\l) -- (-0.35*\costhetaup,-\sinthetaup+1.7*\l);

\draw[red,line width=1.25mm] (\costhetaup,\sinthetaup) -- (0.35*\costhetaup,\sinthetaup+0.3*\l);
\draw[red,line width=1.25mm] (\costhetaup,-\sinthetaup) -- (0.35*\costhetaup,-\sinthetaup-0.3*\l);

\draw[red,line width=1.25mm] (-\costhetaup,\sinthetaup-2*\l) -- (-0.35*\costhetaup,\sinthetaup-1.7*\l);
\draw[red,line width=1.25mm] (-\costhetaup,-\sinthetaup-2*\l) -- (-0.35*\costhetaup,-\sinthetaup-2.3*\l);

\draw[red,line width=1.25mm] (\costhetaup,\sinthetaup-4*\l) -- (0.35*\costhetaup,\sinthetaup-3.7*\l);
\draw[red,line width=1.25mm] (\costhetaup,-\sinthetaup-4*\l) -- (\costhetaup,-\sinthetaup-4.2*\l);
