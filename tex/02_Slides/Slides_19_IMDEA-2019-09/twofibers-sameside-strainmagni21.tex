...
\begin{scope}[style=axes]
  \draw[->,line width=0.75mm] (-3.2*\l,0) -- (41.3*\l,0) node[right] {\Huge$x$};
  \draw[->,line width=0.75mm] (19*\l,-3.2*\l) -- (19*\l,3.3*\l) node[above] {\Huge$z$};
\end{scope}
...
\draw[line width=1.25mm] (-3*\l,3*\l) -- (41*\l,3*\l) ;
\draw[line width=1.25mm] (-3*\l,-3*\l) -- (41*\l,-3*\l) ;
