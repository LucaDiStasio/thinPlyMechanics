...
\begin{scope}[style=axes]
  ...
  \draw[->,line width=0.75mm] (20*\l,-1.2*\l) -- (20*\l,1.3*\l) node[above] {\Huge$z$};
\end{scope}

\foreach \z in {0}{
\foreach \x in {-0.5,0.5,1.5,2.5,3.5,4.5,5.5,6.5,7.5,8.5,9.5,10.5}{
 %debond on the right
...
\draw[line width=1.25mm] (-3*\l,\l) -- (43*\l,\l) ;
\draw[line width=1.25mm] (-3*\l,-\l) -- (43*\l,-\l) ;
\draw[line width=1.25mm] (43*\l,\l) -- (43*\l,-\l);
\draw[line width=1.25mm] (-3*\l,\l) -- (-3*\l,-\l);
...
\draw[below]  (20*\l,-1.5*\l)node{\Huge$\mathbf{1\times k-\cdots}$};
