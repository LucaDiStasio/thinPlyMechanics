...
\draw[red,line width=1.25mm] (-\costhetaup,-\sinthetaup+4*\l) -- (-\costhetaup,\sinthetaup+2*\l);

\draw[red,line width=1.25mm] (-\costhetaup,-\sinthetaup+2*\l) -- (\costhetaup,\sinthetaup);

\draw[red,line width=1.25mm] (\costhetaup,-\sinthetaup) -- (-\costhetaup,\sinthetaup-2*\l);

\draw[red,line width=1.25mm] (-\costhetaup,-\sinthetaup-2*\l) -- (\costhetaup,\sinthetaup-4*\l);
