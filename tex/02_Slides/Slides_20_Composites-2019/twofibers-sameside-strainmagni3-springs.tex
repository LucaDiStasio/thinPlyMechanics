...
\begin{scope}[style=axes]
  \draw[->,white,line width=0.75mm] (-3.2*\l,0) -- (5.3*\l,0) node[right] {\Huge$x$};
  \draw[->,white,line width=0.75mm] (\l,-3.2*\l) -- (\l,3.3*\l) node[above] {\Huge$z$};
\end{scope}
...
\draw[line width=1.25mm] (3*\l,3*\l) -- (5*\l,3*\l) ;
\draw[line width=1.25mm] (3*\l,-3*\l) -- (5*\l,-3*\l) ;
...
%\node [black,scale=2] (-0.5*\l,0) {\drawspring};
...
\draw[decorate,decoration={
        ...
        amplitude=10*\l,
        pre length=\l, 
        post length=.1cm},line width=0.5mm] (-0.5*\l-0.4*\l,0)--(-0.5*\l+1.4*\l,0);
...
\draw[decorate,decoration={
        ...
        amplitude=10*\l,
        pre length=\l, 
        post length=.1cm},line width=0.5mm] (1.5*\l-0.4*\l,0)--(1.5*\l+1.4*\l,0);
        
\draw[->,line width=2.75mm] (6*\l,0) -- (7*\l,0) ;
\draw[above] (6.5*\l,0.5)node{\Huge$\varepsilon_{x}=1\%$};

\draw[->,line width=2.75mm] (-4*\l,0) -- (-5*\l,0) ;
\draw[below] (-4.5*\l,-0.5)node{\Huge$\varepsilon_{x}=1\%$};

\draw[below]  (\l,-3.5*\l)node{\Huge$\mathbf{3\times k-\dots}$};
