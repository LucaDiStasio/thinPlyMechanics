...
\draw[line width=1.25mm] (\costhetaup,\sinthetaup+\x*2*\l)arc (\thetaup:\thetaround:\Rf);
\draw[draw=red,line width=1.25mm](\costhetaup,\sinthetaup+\x*2*\l) arc(\thetaup:\thetabot:\Rf);
\tkzDefPoint(\costhetaup,\sinthetaup+\x*2*\l){A}\tkzDefPoint(1.2*\Rf,0+\x*2*\l){B}\tkzDefPoint(\costhetabot,\sinthetabot+\x*2*\l){C}
...
% debonded fibers +/- 3
\draw[line width=1.25mm] (6*\l-\costhetaup,-\sinthetaup+\x*2*\l)arc (-\thetaup:\thetaround:-\Rf);
\draw[draw=red,line width=1.25mm](6*\l-\costhetaup,\sinthetaup+\x*2*\l) arc(180+\thetabot:180-\thetaup:\Rf);
\tkzDefPoint(6*\l-\costhetaup,\sinthetaup+\x*2*\l){A}\tkzDefPoint(6*\l-1.2*\Rf,0+\x*2*\l){B}\tkzDefPoint(6*\l-\costhetabot,\sinthetabot+\x*2*\l){C}
\tkzCircumCenter(A,B,C)\tkzGetPoint{O}
...
\begin{scope}[style=axes]
  \draw[->,line width=0.75mm] (-7.1*\l,0) -- (7.2*\l,0) node[right] {\Huge$\underline{i}, x$};
...
%top symmetry
\foreach \x in {0,...,12}{
\draw[blue, line width=\symmlinethink](-3*\l+\x*2*\symmsyml,\l)--(-3*\l+\x*2*\symmsyml-0.5*\symmsyml,\l+\symmsymh)--(-3*\l+\x*2*\symmsyml-0.5*\symmsyml+\symmsyml,\l+\symmsymh)--(-3*\l+\x*2*\symmsyml,\l);
\draw[blue, line width=\symmlinethink] (-3*\l+\x*2*\symmsyml,\l+\symmsymh+0.25*\symmsyml,0)arc (0:360:0.25*\symmsyml);
\draw[blue, line width=\symmlinethink] (-3*\l+\x*2*\symmsyml+0.5*\symmsyml,\l+\symmsymh+0.25*\symmsyml,0)arc (0:360:0.25*\symmsyml);}

%left symmetry
\foreach \x in {0,...,2}{
\draw[blue, line width=\symmlinethink](-3*\l,\x*2*\symmsyml)--(-3*\l-\symmsymh,\x*2*\symmsyml-0.5*\symmsyml)--(-3*\l-\symmsymh,\x*2*\symmsyml+0.5*\symmsyml)--(-3*\l,\x*2*\symmsyml);
\draw[blue, line width=\symmlinethink] (-3*\l-\symmsymh,\x*2*\symmsyml-0.25*\symmsyml,0)arc (0:360:0.25*\symmsyml);
\draw[blue, line width=\symmlinethink] (-3*\l-\symmsymh,\x*2*\symmsyml+0.25*\symmsyml,0)arc (0:360:0.25*\symmsyml);}

%right symmetry
\foreach \x in {0,...,2}{
\draw[blue, line width=\symmlinethink](3*\l,\x*2*\symmsyml)--(3*\l+\symmsymh,\x*2*\symmsyml-0.5*\symmsyml)--(3*\l+\symmsymh,\x*2*\symmsyml+0.5*\symmsyml)--(3*\l,\x*2*\symmsyml);
\draw[blue, line width=\symmlinethink] (3*\l+\symmsymh+0.5*\symmsyml,\x*2*\symmsyml-0.25*\symmsyml,0)arc (0:360:0.25*\symmsyml);
\draw[blue, line width=\symmlinethink] (3*\l+\symmsymh+0.5*\symmsyml,\x*2*\symmsyml+0.25*\symmsyml,0)arc (0:360:0.25*\symmsyml);}
...
\draw (0,-3.35*\l) node[blue,left,below] {\Huge$\mathbf{n=3}$};
