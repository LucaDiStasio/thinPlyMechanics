...
\centering
    \begin{subfigure}[b]{0.48\textwidth}
       ...
       \caption{Elements with $1^{st}$ order shape functions: $m=1$ and $p,q=1$.}
    \end{subfigure}
    ~
    \begin{subfigure}[b]{0.48\textwidth}
        \includegraphics[width=\textwidth]{VCCT-quadratic.pdf}
       \caption{Elements with $2^{nd}$ order shape functions: $m=2$ and $p,q=1,2$.}
    \end{subfigure}

\caption{Schematic of the mesh at the fiber/matrix interface crack tip.}\label{fig:vcctmesh}
\end{figure}
