...
\centering
    \begin{subfigure}[b]{0.48\textwidth}
       ...
       \caption{$1^{st}$ order elements, $\delta=0.05^{\circ}$.}
    \end{subfigure}
    ~
    \begin{subfigure}[b]{0.48\textwidth}
    ...
    \begin{subfigure}[b]{0.48\textwidth}
       ...
       \caption{$2^{nd}$ order elements, $\delta=0.05^{\circ}$.}
    \end{subfigure}
    ~
    \begin{subfigure}[b]{0.48\textwidth}
