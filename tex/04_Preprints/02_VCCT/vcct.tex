...
\title{Convergence properties of the ERR in the FEM solution to the fiber/matrix interface crack problem evaluated with the VCCT}
...
\section{Formulaton of the ERR with respect to the FEM solution's variables}
