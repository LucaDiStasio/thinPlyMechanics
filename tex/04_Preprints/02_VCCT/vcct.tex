...
\caption{Effect of the size $\delta$ of an element at the crack tip on Mode II ERR.}\label{fig:gtotrotinvnum}
\end{figure}
...
\caption{Effect of the size $\delta$ of an element at the crack tip on total ERR.}\label{fig:gtotrotinvnum}
\end{figure}
