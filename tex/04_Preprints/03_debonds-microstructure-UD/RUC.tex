...
\begin{scope}[style=axes]
  \draw[->,line width=0.75mm] (-0.5*\symmsyml-\symmsymh-1.05*\loadlim,0) -- (0.5*\symmsyml+\symmsymh+1.15*\loadlim,0) node[right] {\Huge$\underline{i}, x$};
  \draw[->,line width=0.75mm] (0,-0.75*\symmsyml-\symmsymh) -- (0,1.3*\l) node[above] {\Huge$\underline{k}, z$};
\end{scope}
...
\draw (-0.5*\symmsyml-\symmsymh-1.15*\loadlim,0.5*\l) node[blue,left] {\Huge$h$};
