...
The comparison of the $1\times 1-free$  model with one row multi-fiber models $n\times 1-free$ in Figure~\ref{fig:sidefibersMI} and Figure~\ref{fig:sidefibersMI} show that the former provides in general the lowest value of the ERR (the highest crack shielding case) which is consistent with the trends observed in Section~\ref{subsec:singlefiberud}.
