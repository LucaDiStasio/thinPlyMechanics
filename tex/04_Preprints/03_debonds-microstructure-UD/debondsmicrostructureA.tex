...
\subsection{Influence of rows of fully bonded fibers on debond's growth in RUCs with debonds in the central row}\label{subsec:fiberabove}
...
\subsection{Interaction between debonds in UD composites with multiple rows of fibers}\label{subsec:multrow}
