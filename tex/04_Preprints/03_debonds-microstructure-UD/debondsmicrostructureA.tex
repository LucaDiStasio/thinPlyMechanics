...
These observations are in strong agreement with the results reported in~\cite{Sandino2016}, where the effect of two fully bonded nearby fibers, placed simmetrically with respect to the loading direction, is studied for different angular positions and radial distances in a model with an effectively infinite matrix. They reported an increase in both Mode I and Mode II ERR with respect to the single fiber case when the second fiber was placed at an angle of $25^{\circ},30^{\circ},140^{\circ},150^{\circ},155^{\circ}$ with respect to the loading direction, with the partially debonded fiber placed in the center. In the range $40^{\circ}-130^{\circ}$, the presence of the second fiber resulted in a reduction of the ERR at the crack tip. Furthemore, in the range $80^{\circ}-120^{\circ}$ results were very close and almost identical in the case of Mode I; the minimum values in both Mode I and Mode II were found when the fiber was placed at $50^{\circ}-60^{\circ}$. They furthermore observed that the further the fully bonded fibers were placed from the central one, the lower was their effect on the ERR, in agreement with our observations on the effect of fiber content. Analogous results can be found in~\cite{Zhuang2018}, where the authors consider a centrally-placed partially debonded fiber sorrounded by an hexagonal cluster inside an homogenized UD composite. They observed a reduction in the ERR when the spacing between fibers was reduced, i.e. when the local fiber volume fraction was increased.\\
