...
As shown in Figs.~\ref{fig:volumefractionMI} and~\ref{fig:volumefractionMII}, respectively for Mode I and Mode II, the fiber content has a drastic effect on the Energy Release Rate at the crack tip of the fibre/matrix interface crack. Four different levels of the fiber volume fraction are compared: $30\%$
