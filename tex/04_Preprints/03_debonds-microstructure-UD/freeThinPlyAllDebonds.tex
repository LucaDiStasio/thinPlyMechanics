...
\begin{scope}[style=axes]
  ...
  \draw[->,line width=0.75mm] (0,-1.2*\l) -- (0,1.3*\l) node[above] {\Huge$\underline{k}, z$};
\end{scope}
...
\draw[blue,line width=1.25mm] (-\l,-1.25*\l) -- (\l,-1.25*\l) ;
...
\draw (0,-1.35*\l) node[blue,left,below] {\Huge$\mathbf{n=1}$};
