...
\foreach \x in {-1,...,1}{
% debond on the right
\draw[line width=1.25mm] (\costhetaup+\x*4*\l,\sinthetaup+\y*2*\l)arc (\thetaup:\thetaround:\Rf);
\draw[draw=red,line width=1.25mm](\costhetaup+\x*4*\l,\sinthetaup+\y*2*\l) arc(\thetaup:\thetabot:\Rf);
\tkzDefPoint(\costhetaup+\x*4*\l,\sinthetaup+\y*2*\l){A}\tkzDefPoint(1.2*\Rf+\x*4*\l,0+\y*2*\l){B}\tkzDefPoint(\costhetabot+\x*4*\l,\sinthetabot+\y*2*\l){C}
\tkzCircumCenter(A,B,C)\tkzGetPoint{O}
\tkzDrawArc[draw=red,line width=1.25mm](O,C)(A)
}
\foreach \x in {-1,...,0}{
% debond on the left
\draw[line width=1.25mm] (2*\l+\x*4*\l-\costhetaup,-\sinthetaup+\y*2*\l)arc (-\thetaup:\thetaround:-\Rf);
\draw[draw=red,line width=1.25mm](2*\l+\x*4*\l-\costhetaup,\sinthetaup+\y*2*\l) arc(180+\thetabot:180-\thetaup:\Rf);
\tkzDefPoint(2*\l+\x*4*\l-\costhetaup,\sinthetaup+\y*2*\l){A}\tkzDefPoint(2*\l+\x*4*\l-1.2*\Rf,0+\y*2*\l){B}\tkzDefPoint(2*\l+\x*4*\l-\costhetabot,\sinthetabot+\y*2*\l){C}
\tkzCircumCenter(A,B,C)\tkzGetPoint{O}
\tkzDrawArc[draw=red,line width=1.25mm](O,A)(C)
}}

\begin{scope}[style=axes]
  \draw[->,line width=0.75mm] (-5.2*\l,0) -- (5.3*\l,0) node[right] {\Huge$\underline{i}, x$};
  \draw[->,line width=0.75mm] (0,-3.2*\l) -- (0,3.3*\l) node[above] {\Huge$\underline{k}, z$};
\end{scope}

\pgfmathsetmacro\ltot{\l+\tratio*\l}


\draw[line width=1.25mm] (-5*\l,3*\l) -- (5*\l,3*\l) ;
\draw[line width=1.25mm] (-5*\l,-3*\l) -- (5*\l,-3*\l) ;
\draw[line width=1.25mm] (5*\l,3*\l) -- (5*\l,-3*\l);
\draw[line width=1.25mm] (-5*\l,3*\l) -- (-5*\l,-3*\l);


\draw[dashed,blue, line width=1.25mm] (\l,0) -- (\l,\l) ;
\draw[dashed,blue, line width=1.25mm] (-\l,0) -- (-\l,\l) ;
\draw[dashed,blue, line width=1.25mm] (-\l,0) -- (\l,0) ;
\draw[dashed,blue, line width=1.25mm] (-\l,\l) -- (\l,\l) ;
...
%top symmetry
\foreach \x in {4,...,8}{
\draw[dashed,blue, line width=1.25mm](-3*\l+\x*2*\symmsyml,\l)--(-3*\l+\x*2*\symmsyml-0.5*\symmsyml,\l+\symmsymh)--(-3*\l+\x*2*\symmsyml-0.5*\symmsyml+\symmsyml,\l+\symmsymh)--(-3*\l+\x*2*\symmsyml,\l);
\draw[dashed,blue, line width=1.25mm] (-3*\l+\x*2*\symmsyml,\l+\symmsymh+0.25*\symmsyml,0)arc (0:360:0.25*\symmsyml);
\draw[dashed,blue, line width=1.25mm] (-3*\l+\x*2*\symmsyml+0.5*\symmsyml,\l+\symmsymh+0.25*\symmsyml,0)arc (0:360:0.25*\symmsyml);}

%left symmetry
\foreach \x in {0,...,2}{
\draw[dashed,blue, line width=1.25mm](-\l,\x*2*\symmsyml)--(-\l-\symmsymh,\x*2*\symmsyml-0.5*\symmsyml)--(-\l-\symmsymh,\x*2*\symmsyml+0.5*\symmsyml)--(-\l,\x*2*\symmsyml);
\draw[dashed,blue, line width=1.25mm] (-\l-\symmsymh,\x*2*\symmsyml-0.25*\symmsyml,0)arc (0:360:0.25*\symmsyml);
\draw[dashed,blue, line width=1.25mm] (-\l-\symmsymh,\x*2*\symmsyml+0.25*\symmsyml,0)arc (0:360:0.25*\symmsyml);}

%right symmetry
\foreach \x in {0,...,2}{
\draw[dashed,blue, line width=1.25mm](\l,\x*2*\symmsyml)--(\l+\symmsymh,\x*2*\symmsyml-0.5*\symmsyml)--(\l+\symmsymh,\x*2*\symmsyml+0.5*\symmsyml)--(\l,\x*2*\symmsyml);
\draw[dashed,blue, line width=1.25mm] (\l+\symmsymh+0.5*\symmsyml,\x*2*\symmsyml-0.25*\symmsyml,0)arc (0:360:0.25*\symmsyml);
\draw[dashed,blue, line width=1.25mm] (\l+\symmsymh+0.5*\symmsyml,\x*2*\symmsyml+0.25*\symmsyml,0)arc (0:360:0.25*\symmsyml);}

\draw[blue,line width=1.25mm] (-\l,-3.25*\l) -- (\l,-3.25*\l) ;
\draw[blue,line width=1.25mm] (-\l,-3.15*\l) -- (-\l,-3.35*\l) ;
\draw[blue,line width=1.25mm] (\l,-3.15*\l) -- (\l,-3.35*\l) ;

\draw[blue,line width=1.25mm] (-5.25*\l,-\l) -- (-5.25*\l,\l) ;
\draw[blue,line width=1.25mm] (-5.15*\l,\l) -- (-5.35*\l,\l) ;
\draw[blue,line width=1.25mm] (-5.15*\l,-\l) -- (-5.35*\l,-\l) ;

\draw (0,-3.35*\l) node[blue,left,below] {\Huge$\mathbf{n=1}$};
\draw (-5.3*\l,0) node[blue,above,rotate=90] {\Huge$\mathbf{k=1}$};
