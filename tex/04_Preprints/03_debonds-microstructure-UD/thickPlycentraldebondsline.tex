...
\begin{scope}[style=axes]
 \draw[->,line width=0.75mm] (-5.1*\l,0) -- (5.2*\l,0) node[right] {\Huge$\underline{i}, x$};
  \draw[->,line width=0.75mm] (0,-5.2*\l) -- (0,5.3*\l) node[above] {\Huge$\underline{k}, z$};
\end{scope}
...
\draw[blue,line width=1.25mm] (-\l,-5.25*\l) -- (\l,-5.25*\l) ;
\draw[blue,line width=1.25mm] (-\l,-5.15*\l) -- (-\l,-5.35*\l) ;
\draw[blue,line width=1.25mm] (\l,-5.15*\l) -- (\l,-5.35*\l) ;

\draw[blue,line width=1.25mm] (-5.25*\l,-5*\l) -- (-5.25*\l,5*\l) ;
\draw[blue,line width=1.25mm] (-5.15*\l,5*\l) -- (-5.35*\l,5*\l) ;
\draw[blue,line width=1.25mm] (-5.15*\l,-5*\l) -- (-5.35*\l,-5*\l) ;

\draw (0,-5.35*\l) node[blue,left,below] {\Huge$\mathbf{n=1}$};
\draw (-5.3*\l,0) node[blue,above,rotate=90] {\Huge$\mathbf{k=5}$};
