...
\subsection{Effect of the proximity of the $0^{\circ}/90^{\circ}$ bi-material interface and of the thickness of the $0^{\circ}$ layer on debond ERR}
...
We turn now our attention to the models $n\times 1-i\cdot t_{90^{\circ}}$, which correspond to a cross-ply laminate in which the central $90^{\circ}$ ply is constituted by only one fiber row where debonds appear on alternating sides of the damaged fiber at regular intervals of fully bonded fibers (see Figure~\ref{fig:laminateModelsA}). 
