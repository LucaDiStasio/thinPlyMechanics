...
\subsection{Effect of the proximity of the inter-ply interface on debond-debond interaction in a single fiber row $90^{\circ}$ ply of a $\left[0^{\circ}_{n}, 90^{\circ}\right]_{S}$ laminate}
