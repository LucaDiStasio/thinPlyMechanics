...
The presence of the $0^{\circ}/90^{\circ}$ $0^{\circ}/90^{\circ}$ interface causes instead a decrease of Mode II for open debonds ($\Delta\theta<60^{\circ}-70^{\circ}$) and a decrease for close debonds ($\Delta\theta>60^{\circ}-70^{\circ}$) with respect to the free surface case (see Fig.~\ref{fig:thicknessGII}). 
