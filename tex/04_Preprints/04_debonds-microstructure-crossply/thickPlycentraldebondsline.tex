...
\draw[dashed,blue, line width=1.25mm] (\l,0) -- (\l,9*\l) ;
\draw[dashed,blue, line width=1.25mm] (-\l,0) -- (-\l,9*\l) ;
\draw[dashed,blue, line width=1.25mm] (-\l,0) -- (\l,0) ;
\draw[dashed,blue, line width=1.25mm] (-\l,9*\l) -- (\l,9*\l) ;
...
\draw[blue,line width=1.25mm] (-\l,-9.25*\l) -- (\l,-9.25*\l) ;
\draw[blue,line width=1.25mm] (-\l,-9.15*\l) -- (-\l,-9.35*\l) ;
\draw[blue,line width=1.25mm] (\l,-9.15*\l) -- (\l,-9.35*\l) ;
...
\draw (0,-9.35*\l) node[blue,left,below] {\Huge$\mathbf{n=1}$};
\draw (-7.3*\l,0) node[blue,above,rotate=90] {\Huge$\mathbf{k=3}$};

\draw (8.3*\l,6*\l) node[blue,below,rotate=90] {\Huge$\mathbf{i\cdot t_{90^{\circ}}}$};
\draw (8.3*\l,-6*\l) node[blue,below,rotate=90] {\Huge$\mathbf{i\cdot t_{90^{\circ}}}$};
