...
\tkzDefPoint(-\costhetaup+2*\l+\x*4*\l,\sinthetaup){A}\tkzDefPoint(-1.2*\Rf+2*\l+\x*4*\l,0){B}\tkzDefPoint(-\costhetabot+2*\l+\x*4*\l,\sinthetabot){C}
\tkzCircumCenter(A,B,C)\tkzGetPoint{O}
...
\draw[line width=1.25mm] (7*\l,\l) -- (7*\l,3*\l);
\draw[line width=1.25mm] (-7*\l,\l) -- (-7*\l,3*\l);
\draw[line width=1.25mm] (7*\l,-\l) -- (7*\l,-3*\l);
\draw[line width=1.25mm] (-7*\l,-\l) -- (-7*\l,-3*\l);
...
%left symmetry
\foreach \x in {0,...,6}{
\draw[dashed,blue, line width=\symmlinethink](-\l,\x*2*\symmsyml)--(-\l-\symmsymh,\x*2*\symmsyml-0.5*\symmsyml)--(-\l-\symmsymh,\x*2*\symmsyml+0.5*\symmsyml)--(-\l,\x*2*\symmsyml);
\draw[dashed,blue, line width=\symmlinethink] (-\l-\symmsymh,\x*2*\symmsyml-0.25*\symmsyml,0)arc (0:360:0.25*\symmsyml);
\draw[dashed,blue, line width=\symmlinethink] (-\l-\symmsymh,\x*2*\symmsyml+0.25*\symmsyml,0)arc (0:360:0.25*\symmsyml);}

%right symmetry
\foreach \x in {0,...,6}{
\draw[dashed,blue, line width=\symmlinethink](\l,\x*2*\symmsyml)--(\l+\symmsymh,\x*2*\symmsyml-0.5*\symmsyml)--(\l+\symmsymh,\x*2*\symmsyml+0.5*\symmsyml)--(\l,\x*2*\symmsyml);
\draw[dashed,blue, line width=\symmlinethink] (\l+\symmsymh+0.5*\symmsyml,\x*2*\symmsyml-0.25*\symmsyml,0)arc (0:360:0.25*\symmsyml);
\draw[dashed,blue, line width=\symmlinethink] (\l+\symmsymh+0.5*\symmsyml,\x*2*\symmsyml+0.25*\symmsyml,0)arc (0:360:0.25*\symmsyml);}
...
\draw[->,line width=1.25mm] (5*\l,2*\l) -- (6*\l,2*\l)node[right] {\Huge$\mathbf{0^{\circ}}$};
\draw[->,line width=1.25mm] (5*\l,-2*\l) -- (6*\l,-2*\l)node[right] {\Huge$\mathbf{0^{\circ}}$};
...
\draw (8.3*\l,2*\l) node[blue,below,rotate=90] {\Huge$\mathbf{p\cdot t_{90^{\circ}}}$};
\draw (8.3*\l,-2*\l) node[blue,below,rotate=90] {\Huge$\mathbf{p\cdot t_{90^{\circ}}}$};
