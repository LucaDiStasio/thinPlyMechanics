...
G\sim f\left(\Delta\theta\right)\frac{E_{2}}{1-\nu_{12}\nu_{21}}\varepsilon_{0}^{2}l_{ref}\quad G\sim f\left(\Delta\theta\right)E_{2}\varepsilon_{0}^{2}l_{ref},
\end{equation}
...
G\sim f\left(\Delta\theta\right)\frac{1-\nu_{12}\nu_{21}}{E_{2}}\sigma_{0}^{2}l_{ref}\quad G\sim f\left(\Delta\theta\right)\frac{\sigma_{0}^{2}}{E_{2}}l_{ref},
\end{equation}
