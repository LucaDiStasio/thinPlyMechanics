...
\draw[loosely dashed,blue, line width=1.25mm] (3*\l,0) -- (3*\l,9*\l) ;
\draw[loosely dashed,blue, line width=1.25mm] (-3*\l,0) -- (-3*\l,9*\l) ;
\draw[loosely dashed,blue, line width=1.25mm] (-3*\l,0) -- (3*\l,0) ;
\draw[loosely dashed,blue, line width=1.25mm] (-3*\l,9*\l) -- (3*\l,9*\l) ;
...
\draw(6*\l,6*\l)node[right] {\Huge$\mathbf{0^{\circ}}$};
\draw(6*\l,-6*\l)node[right] {\Huge$\mathbf{0^{\circ}}$};

\draw (1*\l,-1*\l) node[blue] {\Huge$\mathbf{n=3}$};
\draw (-2*\l,\l) node[blue] {\Huge$\mathbf{k=3}$};

\draw (8.3*\l,6*\l) node[blue,right] {\Huge$\mathbf{t_{0^{\circ}}=m\cdot t_{90^{\circ}}}$};
\draw (8.3*\l,-6*\l) node[blue,right] {\Huge$\mathbf{t_{0^{\circ}}=m\cdot t_{90^{\circ}}}$};
