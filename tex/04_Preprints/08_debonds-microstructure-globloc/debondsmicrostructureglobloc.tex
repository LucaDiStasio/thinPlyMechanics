...
+&\frac{1}{\Delta\theta}\int_{\Delta\Psi}^{\Delta\theta}COD_{max}\sum_{k=0}^{n-1}a_{2k+1}\left(\theta-\frac{\Delta\Psi}{2}\right)^{2k+1}d\theta=\\
=&\frac{1}{\Delta\theta}\left[COD_{avg}\theta+COD_{max}\sum_{k=0}^{n-1}\frac{a_{2k+1}}{2\left(k+1\right)}\left(\theta-\frac{\Delta\Psi}{2}\right)^{2\left(k+1\right)}\right]\Bigg\rvert_{0}^{\Delta\Psi}=\\
=&\frac{\Delta\Psi}{\Delta\theta}COD_{avg}+COD_{max}\sum_{k=0}^{n-1}\frac{a_{2k+1}}{2\left(k+1\right)\Delta\theta}\left(\left(\frac{\Delta\Psi}{2}\right)^{2\left(k+1\right)}-\left(-\frac{\Delta\Psi}{2}\right)^{2\left(k+1\right)}\right)=\\
=&\frac{\Delta\Psi}{\Delta\theta}COD_{avg}
\end{aligned}
\end{equation}
...
\footnotesize
\begin{aligned}
&\frac{1}{\Delta\theta}\int_{0}^{\Delta\Psi}COD\left(\theta\right)\sin\left(2\theta\right)d\theta=\\
=&\frac{1}{\Delta\theta}\int_{0}^{\Delta\Psi}\left(COD_{avg}+COD_{max}\sum_{k=0}^{n-1}a_{2k+1}\theta^{2k+1}\right)\sin\left(2\theta\right)d\theta=\\
=&-\frac{1}{2\Delta\theta}COD_{avg}\left[\cos\left(2\theta\right)\right]\Bigg\rvert_{0}^{\Delta\Psi}+\\
+&\frac{1}{\Delta\theta}\left[COD_{max}\sum_{i=0}^{n-1}\left(-\frac{1}{2}\right)^{2i+1}\sin(\frac{1+mod\left(i,2\right)}{2}\pi-2\theta)\left(\sum_{k=0}^{i}a_{2k+1}\left(\left(n-1\right)-2\left(k+1\right)\right)!\theta^{2\left(k+1\right)}\right)\right]\Bigg\rvert_{0}^{\Delta\Psi}=\\
=&\frac{1}{2\Delta\theta}COD_{avg}\left(1-\cos\left(2\Delta\Psi\right)\right)+\\
+&\frac{1}{\Delta\theta}COD_{max}\sum_{i=0}^{n-1}\left(-\frac{1}{2}\right)^{2i+1}\sin\left(\frac{1+mod\left(i,2\right)}{2}\pi-2\Delta\Psi\right)\left(\sum_{k=0}^{i}a_{2k+1}\left(\left(n-1\right)-2\left(k+1\right)\right)!\Delta\Psi^{2\left(k+1\right)}\right)
\end{aligned}
\end{equation}
