...
=&\frac{1}{\Delta\Psi}\left[COD_{avg}\theta+COD_{max}\sum_{k=0}^{n-1}\frac{a_{2k+1}}{2\left(k+1\right)}\left(\theta-\frac{\Delta\Psi}{2}\right)^{2\left(k+1\right)}\right]\Bigg\rvert_{0}^{\Delta\Psi}=\\
=&COD_{avg}+COD_{max}\sum_{k=0}^{n-1}\frac{a_{2k+1}}{2\left(k+1\right)}\frac{\Delta\Psi^{2\left(k+1\right)}}{\Delta\theta}
\end{aligned}
\end{equation}
