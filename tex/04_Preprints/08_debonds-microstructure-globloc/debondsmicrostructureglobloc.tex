...
\begin{equation}
\beta_{22}=\rho_{D}\left[\frac{1}{\Delta\theta}\int_{0}^{\Delta\theta}\left(COD\left(\theta\right)\left(\sin{\left(\theta\right)}\cos{\left(\theta\right)}-\sin^{2}{\left(\theta\right)}\right)+CSD\left(\theta\right)\left(\cos^{2}{\left(\theta\right)}-\cos{\left(\theta\right)}\sin{\left(\theta\right)}\right)\right)d\theta\right]\\
\end{equation}

\subsection{Modeling $COD\left(\theta\right)$ and $CSD\left(\theta\right)$}
...
\begin{equation}
f\left(\theta\right)=a_{0}+\sum_{k=0}^{n}a_{2k+1}\theta^{2k+1}\quad g\left(\theta\right)=b_{0}+\sum_{k=0}^{n}b_{2k+1}\theta^{2k+1}
\end{equation}

\begin{equation}
\begin{aligned}
COD\left(\Delta\Phi\right)&=COD_{avg}+COD_{max}\left(a_{0}+\sum_{k=0}^{n}a_{2k+1}\Delta\Phi^{2k+1}\right)=0\\
CSD\left(\Delta\Theta\right)&=CSD_{avg}+CSD_{max}\left(b_{0}+\sum_{k=0}^{n}b_{2k+1}\Delta\Theta^{2k+1}\right)=0
\end{aligned}
\end{equation}

\begin{equation}
\begin{aligned}
a_{0}&=-\left(\frac{COD_{avg}}{COD_{max}}+\sum_{k=0}^{n}a_{2k+1}\Delta\Phi^{2k+1}\right)\\
b_{0}&=-\left(\frac{CSD_{avg}}{CSD_{max}}+\sum_{k=0}^{n}b_{2k+1}\Delta\Theta^{2k+1}\right)
\end{aligned}
\end{equation}
...
\begin{equation}
\begin{aligned}
\int_{0}^{\Delta\theta}f\left(\theta\right)\sin\left(\frac{\pi}{4}-2\Delta\theta\right)d\theta=\left[\sum_{k=1}^{n}\left(-1\right)^{k}\sin\left(\frac{k}{2}\pi+\left(k-1\right)\pi-\left(\frac{\pi}{4}-2\Delta\theta\right)\right)\right]_{0}^{\Delta\theta}
\end{aligned}
\end{equation}
