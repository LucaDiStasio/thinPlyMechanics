...
\foreach \z in {0}{
\foreach \x in {-1,1}{
\draw[line width=1.25mm] (\Rf+\x*2*\clustRatio*\l,\y*6*\l+\z*2*\clustRatio*\l)arc (0:360:\Rf);
}
\foreach \x in {0}{
% debond on the right
\draw[line width=1.25mm] (\costhetaup+\x*2*\l,\y*6*\l+\sinthetaup+\z*6*\l)arc (\thetaup:\thetaround:\Rf);
\draw[draw=red,line width=1.25mm](\costhetaup+\x*2*\l,\y*6*\l+\sinthetaup+\z*6*\l) arc(\thetaup:\thetabot:\Rf);
\tkzDefPoint(\costhetaup+\x*2*\l,\y*6*\l+\sinthetaup+\z*6*\l){A}\tkzDefPoint(1.2*\Rf+\x*2*\l,\y*6*\l+0+\z*6*\l){B}\tkzDefPoint(\costhetabot+\x*2*\l,\y*6*\l+\sinthetabot+\z*6*\l){C};
...
\foreach \z in {0}{
\foreach \x in {-1,1}{
\draw[line width=1.25mm] (\k*6*\l+\Rf+\x*2*\clustRatio*\l,\y*6*\l+\z*2*\clustRatio*\l)arc (0:360:\Rf);
}
\foreach \x in {0}{
% debond on the left
\draw[line width=1.25mm] (\k*6*\l+\x*2*\l-\costhetaup,\y*6*\l-\sinthetaup+\z*6*\l)arc (-\thetaup:\thetaround:-\Rf);
\draw[draw=red,line width=1.25mm](\k*6*\l+\x*2*\l-\costhetaup,\y*6*\l+\sinthetaup+\z*6*\l) arc(180+\thetabot:180-\thetaup:\Rf);
\tkzDefPoint(\k*6*\l+\x*2*\l-\costhetaup,\y*6*\l+\sinthetaup+\z*6*\l){A}\tkzDefPoint(\k*6*\l+\x*2*\l-1.2*\Rf,\y*6*\l+0+\z*6*\l){B}\tkzDefPoint(\k*6*\l+\x*2*\l-\costhetabot,\y*6*\l+\sinthetabot+\z*6*\l){C};
\tkzCircumCenter(A,B,C)\tkzGetPoint{O};
...
\begin{scope}[style=axes]
  \draw[->,line width=0.75mm] (-9.2*\l,0) -- (9.3*\l,0) node[right] {\Huge$\underline{i}, x$};
...
\draw[line width=1.25mm] (-9*\l,9*\l) -- (9*\l,9*\l) ;
\draw[line width=1.25mm] (-9*\l,-9*\l) -- (9*\l,-9*\l) ;
\draw[line width=1.25mm] (9*\l,9*\l) -- (9*\l,-9*\l);
\draw[line width=1.25mm] (-9*\l,9*\l) -- (-9*\l,-9*\l);
...
\draw[blue,line width=1.25mm] (-9.25*\l,-3*\l) -- (-9.25*\l,3*\l) ;
\draw[blue,line width=1.25mm] (-9.15*\l,3*\l) -- (-9.35*\l,3*\l) ;
\draw[blue,line width=1.25mm] (-9.15*\l,-3*\l) -- (-9.35*\l,-3*\l) ;

\draw (0,-9.35*\l) node[blue,left,below] {\Huge$\mathbf{n=3}$};
\draw (-9.3*\l,0) node[blue,above,rotate=90] {\Huge$\mathbf{k=3}$};
