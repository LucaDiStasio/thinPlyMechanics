...
\item $\sigma_{rr}$, $\sigma_{LHS,2D}$, $\sigma_{LHS,3D}$, $\sigma_{vM,2D}$, $\sigma_{LMPS,2D}$ and $\sigma_{LMPS,3D}$ all reach their peak value at $0^{\circ}$ and $180^{\circ}$ and decrease to $99\%$ the peak value between $2^{\circ}$ and $8^{\circ}$, to $95\%$ the peak value between $6^{\circ}$ and $12^{\circ}$ and to $90\%$ the peak value between $8^{\circ}$ and $15^{\circ}$.
\end{enumerate}
...
\begin{figure}[!h]
\centering
    \subfigure[$\lambda=0.3$]{\label{fig:GIc-a}\includegraphics[height=0.25\textheight]{vf60-GIc-model.pdf}}\  
...
\centering
    \subfigure[$\lambda=0.3$]{\label{fig:GIc-a}\includegraphics[height=0.25\textheight]{vf60-GIc-model.pdf}}\  
    \subfigure[$11\times 11-1\cdot t_{90^{\circ}}$]{\label{fig:GIc-b}\includegraphics[height=0.25\textheight]{vf60-GIc-lambda.pdf}}
\caption{Expected maximum size of debonds, for different RUCs and varying values of $G_{Ic}$ and $\lambda$.}\label{fig:GIc}
\end{figure}
