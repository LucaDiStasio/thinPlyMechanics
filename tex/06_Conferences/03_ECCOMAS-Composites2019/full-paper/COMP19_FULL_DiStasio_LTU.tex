...
\begin{figure}[!h]
\centering
    \subfigure[$\lambda=0.3$]{\label{fig:GIc-a}\includegraphics[height=0.23\textheight]{vf60-GIc-model.pdf}}\quad 
    \subfigure[$11\times 11-1\cdot t_{90^{\circ}}$]{\label{fig:GIc-b}\includegraphics[height=0.23\textheight]{vf60-GIc-lambda.pdf}}
