...
% debond on the right
\draw[line width=1.25mm] (-\costhetaup+\x*4*\l,-\sinthetaup+\z*6*\l)arc (-\thetaup:\thetaround:-\Rf);
\draw[draw=red,line width=1.25mm](-\costhetaup+\x*4*\l,\sinthetaup+\z*6*\l) arc(180+\thetabot:180-\thetaup:\Rf);
\tkzDefPoint(-\costhetaup+\x*4*\l,\sinthetaup+\z*6*\l){A}\tkzDefPoint(-1.2*\Rf+\x*4*\l,0+\z*6*\l){B}\tkzDefPoint(-\costhetabot+\x*4*\l,\sinthetabot+\z*6*\l){C}
\tkzCircumCenter(A,B,C)\tkzGetPoint{O}
\tkzDrawArc[draw=red,line width=1.25mm](O,A)(C)
}
...
% debond on the left
\draw[line width=1.25mm] (2*\l+\x*4*\l+\costhetaup,\sinthetaup+\z*6*\l)arc (\thetaup:\thetaround:\Rf);
\draw[draw=red,line width=1.25mm](2*\l+\x*4*\l+\costhetaup,\sinthetaup+\z*6*\l) arc(\thetaup:\thetabot:\Rf);
\tkzDefPoint(2*\l+\x*4*\l+\costhetaup,\sinthetaup+\z*6*\l){A}\tkzDefPoint(2*\l+\x*4*\l+1.2*\Rf,0+\z*6*\l){B}\tkzDefPoint(2*\l+\x*4*\l+\costhetabot,\sinthetabot+\z*6*\l){C}
\tkzCircumCenter(A,B,C)\tkzGetPoint{O}
\tkzDrawArc[draw=red,line width=1.25mm](O,C)(A)
}
...
\begin{scope}[style=axes]
  ...
  \draw[->,line width=0.75mm] (0,-7.2*\l) -- (0,7.3*\l) node[above] {\Huge$z$};
\end{scope}

\pgfmathsetmacro\ltot{\l+\tratio*\l}


\draw[line width=1.25mm] (-7*\l,7*\l) -- (7*\l,7*\l) ;
\draw[line width=1.25mm] (-7*\l,-7*\l) -- (7*\l,-7*\l) ;
\draw[line width=1.25mm] (7*\l,7*\l) -- (7*\l,-7*\l);
\draw[line width=1.25mm] (-7*\l,7*\l) -- (-7*\l,-7*\l);


\draw[loosely dashed,blue, line width=1.25mm] (3*\l,0) -- (3*\l,3*\l) ;
\draw[loosely dashed,blue, line width=1.25mm] (-3*\l,0) -- (-3*\l,3*\l) ;
\draw[loosely dashed,blue, line width=1.25mm] (-3*\l,0) -- (3*\l,0) ;
\draw[loosely dashed,blue, line width=1.25mm] (-3*\l,3*\l) -- (3*\l,3*\l) ;
...
\draw[blue,line width=1.25mm] (8.25*\l,-5*\l) -- (8.25*\l,5*\l) ;
\draw[blue,loosely dashed,line width=1.25mm] (8.25*\l,-7*\l) -- (8.25*\l,-5*\l) ;
\draw[blue,loosely dashed,line width=1.25mm] (8.25*\l,5*\l) -- (8.25*\l,7*\l) ;

\draw (1*\l,-1*\l) node[blue] {\Huge$\mathbf{n=3}$};
\draw (-2*\l,\l) node[blue] {\Huge$\mathbf{k=3}$};
\draw (8.3*\l,0) node[blue,right] {\Huge$\mathbf{t_{0^{\circ}}\rightarrow\infty}$};
