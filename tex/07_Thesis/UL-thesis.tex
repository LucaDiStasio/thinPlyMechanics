...
%-------------------------------------------------------------------
\documentclass[12pt,a4paper,openright,final,twoside]{msethesisul}
...
\def\theabstract{\input{abstractFR.tex}}
...
%\makechapter{The fiber/matrix interface crack}{The fiber/matrix interface crack}{The fiber/matrix interface crack}
%\input{chapters/chapter2.tex}

\makechapter{Summary of appended papers}{Summary of appended papers}{Summary of appended papers}
...
\def\referencestring{Finite Elements in Analysis and Design, Volume 167, December 2019, 103332.}
