...
\item[Increased competitiveness.] During the last couple of decades, the arrival of new players and the introduction of new business models have increased competitiveness in the transport sector and pushed toward price reductions. 

\begin{figure}[!h]
\includegraphics[width=\textwidth]{pics/airlinefarecost.pdf}
...
\begin{figure}[!h]
\includegraphics[width=\textwidth]{pics/spacetravelcost.pdf}
\caption{Total $CO_{2}$ emissions due to transport over time, compared with selected geographical entities. Source: , available at \href{}{} (last access: , 2019).}\label{chap1:fig:spacetravelcost}
\end{figure}

\section{\emph{Thin-ply} laminates and the \emph{spread tow} technology}
