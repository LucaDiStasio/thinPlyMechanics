...
\pgfmathsetmacro\xCtoCBF{0.5*(\xC+\xCBF)}
\pgfmathsetmacro\yCtoCBF{0.5*(\yC+\yCBF)}
\pgfmathsetmacro\xDtoDBF{0.5*(\xD+\xDBF)}
\pgfmathsetmacro\yDtoDBF{0.5*(\yD+\yDBF)}
\pgfmathsetmacro\xCtoD{0.5*(\xC+\xD)}
\pgfmathsetmacro\yCtoD{0.5*(\yC+\yD)}
\pgfmathsetmacro\xCTBFtoCBF{0.5*(\xCTBF+\xCBF)}
\pgfmathsetmacro\yCTBFtoCBF{0.5*(\yCTBF+\yCBF)}
\pgfmathsetmacro\xCBFtoDBF{0.5*(\xCBF+\xDBF)}
\pgfmathsetmacro\yCBFtoDBF{0.5*(\yCBF+\yDBF)}
...
\draw[white,fill=white] (0.85*\xCC,0.85*\yCC) rectangle(0.95*\xCC,\yCC);
\node[anchor= north east,text=purple] at (\xCC,\yCC)  {\Huge \bf{p=2}};
...
\draw[white,fill=white] (1.01*\xEE,\yEE) rectangle(1.15*\xEE,1.15*\yEE);
\node[anchor= south west,text=purple] at (1.01*\xEE,\yEE)  {\Huge \bf{p=2}};
