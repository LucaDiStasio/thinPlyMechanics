...
\begin{scope}[style=axes]
 \draw[->,line width=0.75mm] (-5.1*\l,0) -- (5.2*\l,0) node[right] {\Huge$x$};
...
%bottom symmetry
\foreach \x in {4,...,8}{
\draw[blue, line width=1.25mm](-3*\l+\x*2*\symmsyml,0)--(-3*\l+\x*2*\symmsyml-0.5*\symmsyml,-\symmsymh)--(-3*\l+\x*2*\symmsyml-0.5*\symmsyml+\symmsyml,-\symmsymh)--(-3*\l+\x*2*\symmsyml,0);
\draw[blue, line width=1.25mm] (-3*\l+\x*2*\symmsyml,-\symmsymh-0.25*\symmsyml,0)arc (0:360:0.25*\symmsyml);
\draw[blue, line width=1.25mm] (-3*\l+\x*2*\symmsyml+0.5*\symmsyml,-\symmsymh-0.25*\symmsyml,0)arc (0:360:0.25*\symmsyml);}

%left symmetry
\foreach \x in {0,...,6}{
\draw[blue, line width=1.25mm](-\l,\x*2*\symmsyml)--(-\l-\symmsymh,\x*2*\symmsyml-0.5*\symmsyml)--(-\l-\symmsymh,\x*2*\symmsyml+0.5*\symmsyml)--(-\l,\x*2*\symmsyml);
\draw[blue, line width=1.25mm] (-\l-\symmsymh,\x*2*\symmsyml-0.25*\symmsyml,0)arc (0:360:0.25*\symmsyml);
\draw[blue, line width=1.25mm] (-\l-\symmsymh,\x*2*\symmsyml+0.25*\symmsyml,0)arc (0:360:0.25*\symmsyml);}

%right symmetry
\foreach \x in {0,...,6}{
\draw[blue, line width=1.25mm](\l,\x*2*\symmsyml)--(\l+\symmsymh,\x*2*\symmsyml-0.5*\symmsyml)--(\l+\symmsymh,\x*2*\symmsyml+0.5*\symmsyml)--(\l,\x*2*\symmsyml);
\draw[blue, line width=1.25mm] (\l+\symmsymh+0.5*\symmsyml,\x*2*\symmsyml-0.25*\symmsyml,0)arc (0:360:0.25*\symmsyml);
\draw[blue, line width=1.25mm] (\l+\symmsymh+0.5*\symmsyml,\x*2*\symmsyml+0.25*\symmsyml,0)arc (0:360:0.25*\symmsyml);}
