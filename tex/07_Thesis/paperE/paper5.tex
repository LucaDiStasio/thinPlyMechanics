...
\begin{figure}[!h]
\centering
    \subfigure[$n\times k-free$]{\label{paperE:fig:rves-a}\raisebox{0.07\textheight}{\includegraphics[width=0.4\textwidth]{thickPlyUD.pdf}}}\quad
    \subfigure[$n\times k-coupling$]{\label{paperE:fig:rves-b}\includegraphics[width=0.4\textwidth]{coupling.pdf}}\\
    \subfigure[$n\times k-asymm$]{\label{paperE:fig:rves-c}\raisebox{0.0275\textheight}{\includegraphics[width=0.4\textwidth]{asymm.pdf}}}\quad
    \subfigure[$n\times k-m\times t_{90^{\circ}}$]{\label{paperE:fig:rves-d}\includegraphics[width=0.4\textwidth]{ThickPlyCP.pdf}}
...
\begin{figure}[!hp]
\centering
    \subfigure[Radial stress $\sigma_{rr}$]{\label{paperE:fig:stress-a}\includegraphics[height=0.2\textheight]{vf60-nodamage-sigmar.pdf}}\
    \subfigure[Shear stress $\tau_{r\psi}$]{\label{paperE:fig:stress-b}\raisebox{0.04\textheight}{\includegraphics[height=0.16\textheight]{vf60-nodamage-taurt.pdf}}}\\
    \subfigure[Local Hydrostatic Stress (LHS), neglecting $\sigma_{yy}$, $\sigma_{LHS,2D}$.]{\label{paperE:fig:stress-c}\includegraphics[height=0.2\textheight]{vf60-nodamage-p2D.pdf}}\
    \subfigure[Local Hydrostatic Stress (LHS), considering $\sigma_{yy}$, $\sigma_{LHS,3D}$.]{\label{paperE:fig:stress-d}\includegraphics[height=0.2\textheight]{vf60-nodamage-p3D.pdf}}
    \subfigure[Local von Mises stress, neglecting $\sigma_{yy}$, $\sigma_{vM,2D}$.]{\label{paperE:fig:stress-e}\includegraphics[height=0.2\textheight]{vf60-nodamage-vM2D.pdf}}\
    \subfigure[Local von Mises stress, considering $\sigma_{yy}$, $\sigma_{vM,3D}$.]{\label{paperE:fig:stress-f}\raisebox{0.04\textheight}{\includegraphics[height=0.16\textheight]{vf60-nodamage-vM3D.pdf}}}
    \subfigure[Local Maximum Principal Stress (LMPS), neglecting $\sigma_{yy}$, $\sigma_{LMPS,2D}$.]{\label{paperE:fig:stress-g}\includegraphics[height=0.2\textheight]{vf60-nodamage-sigmaI2D.pdf}}\
    \subfigure[Local Maximum Principal Stress (LMPS), considering $\sigma_{yy}$, $\sigma_{LMPS,3D}$.]{\label{paperE:fig:stress-h}\includegraphics[height=0.2\textheight]{vf60-nodamage-sigmaI3D.pdf}}
...
\begin{figure}[!h]
\centering
    \subfigure[$\lambda=0.3$]{\label{paperE:fig:GIc-a}\includegraphics[height=0.23\textheight]{vf60-GIc-model.pdf}}\quad
    \subfigure[$11\times 11-1\cdot t_{90^{\circ}}$]{\label{paperE:fig:GIc-b}\includegraphics[height=0.23\textheight]{vf60-GIc-lambda.pdf}}
...
\begin{figure}[!htbp]
\centering
    \subfigure[$21\times 1-free$]{\label{paperE:fig:debondsize-a}\includegraphics[width=0.45\textwidth]{vf60-dsize-S10A0.pdf}}\
    \subfigure[$21\times 1-1\cdot t_{90^{\circ}}$]{\label{paperE:fig:debondsize-b}\includegraphics[width=0.45\textwidth]{vf60-dsize-S10A0T1.pdf}}\\
    \subfigure[$21\times 3-free$]{\label{paperE:fig:debondsize-c}\includegraphics[width=0.45\textwidth]{vf60-dsize-S10A3.pdf}}\
    \subfigure[$21\times 3-1\cdot t_{90^{\circ}}$]{\label{paperE:fig:debondsize-d}\includegraphics[width=0.45\textwidth]{vf60-dsize-S10A3T1.pdf}}\\
    \subfigure[$21\times 21-free$]{\label{paperE:fig:debondsize-e}\includegraphics[width=0.45\textwidth]{vf60-dsize-S10A10.pdf}}\
    \subfigure[$21\times 21-1\cdot t_{90^{\circ}}$]{\label{paperE:fig:debondsize-f}\includegraphics[width=0.45\textwidth]{vf60-dsize-S10A10T1.pdf}}\\
    \subfigure[$21\times 1-coupling$]{\label{paperE:fig:debondsize-g}\includegraphics[width=0.45\textwidth]{vf60-dsize-S10A0vk.pdf}}\
    \subfigure[$21\times 1-asymm$]{\label{paperE:fig:debondsize-h}\includegraphics[width=0.45\textwidth]{vf60-dsize-S10A0asymm.pdf}}
