...
%\node[white, below]  at (-4,-0.65) {\tiny$\mathbf{\sim 15\ mm}$};
...
\draw[->,black, line width = 5pt] (-2,0) -- (-2,-3);
\node  at (-2,0) {\includegraphics[height=13.75cm]{0-90_symm_edge}};
\draw[<->,white, line width = 1.25pt] (-2.46,-0.6) -- (-1.55,-0.6);
\node[white, below]  at (-2,-0.625) {\Huge$\mathbf{\sim 2\ mm}$};
