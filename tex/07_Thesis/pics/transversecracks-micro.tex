...
\draw[->,black, line width = 5pt] (1,0) -- (4,0);
\draw[->,black, line width = 5pt] (1,0) -- (-2,0);
\node  at (1,0) {\includegraphics[height=13.75cm]{0-90_symm_debondetail}};
\draw[<->,white, line width = 1.25pt] (0.075,-0.15) -- (1.1,-0.15);
\node[white, below]  at (0.55,-0.16) {\Huge$\mathbf{\sim 8\ \mu m}$};
\node[right]  at (4,0) {\Huge$\mathbf{\varepsilon}$};
\node[left]  at (-2,0) {\Huge$\mathbf{\varepsilon}$};
%
