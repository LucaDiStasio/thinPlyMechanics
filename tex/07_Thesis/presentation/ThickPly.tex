...
\begin{tikzpicture}[scale=0.75,cap=round,x=1cm,y=1cm]
...
\begin{scope}[style=axes]
  ...
  \draw[->,line width=0.75mm] (0,-9.2*\l) -- (0,9.3*\l) node[above] {\Huge$ z$};
\end{scope}
...
\draw[dashed,blue, line width=0.75mm] (3*\l,0) -- (3*\l,9*\l) ;
\draw[dashed,blue, line width=0.75mm] (-3*\l,0) -- (-3*\l,9*\l) ;
\draw[dashed,blue, line width=0.75mm] (-3*\l,0) -- (3*\l,0) ;
\draw[dashed,blue, line width=0.75mm] (-3*\l,9*\l) -- (3*\l,9*\l) ;

%bottom symmetry
\foreach \x in {0,...,12}{
\draw[dashed,blue, line width=0.75mm](-3*\l+\x*2*\symmsyml,0)--(-3*\l+\x*2*\symmsyml-0.5*\symmsyml,-\symmsymh)--(-3*\l+\x*2*\symmsyml-0.5*\symmsyml+\symmsyml,-\symmsymh)--(-3*\l+\x*2*\symmsyml,0);
\draw[dashed,blue, line width=0.75mm] (-3*\l+\x*2*\symmsyml,-\symmsymh-0.25*\symmsyml,0)arc (0:360:0.25*\symmsyml);
\draw[dashed,blue, line width=0.75mm] (-3*\l+\x*2*\symmsyml+0.5*\symmsyml,-\symmsymh-0.25*\symmsyml,0)arc (0:360:0.25*\symmsyml);}

%left symmetry
\foreach \x in {0,...,18}{
\draw[dashed,blue, line width=0.75mm](-3*\l,\x*2*\symmsyml)--(-3*\l-\symmsymh,\x*2*\symmsyml-0.5*\symmsyml)--(-3*\l-\symmsymh,\x*2*\symmsyml+0.5*\symmsyml)--(-3*\l,\x*2*\symmsyml);
\draw[dashed,blue, line width=0.75mm] (-3*\l-\symmsymh,\x*2*\symmsyml-0.25*\symmsyml,0)arc (0:360:0.25*\symmsyml);
\draw[dashed,blue, line width=0.75mm] (-3*\l-\symmsymh,\x*2*\symmsyml+0.25*\symmsyml,0)arc (0:360:0.25*\symmsyml);}

%right symmetry
\foreach \x in {0,...,18}{
\draw[dashed,blue, line width=0.75mm](3*\l,\x*2*\symmsyml)--(3*\l+\symmsymh,\x*2*\symmsyml-0.5*\symmsyml)--(3*\l+\symmsymh,\x*2*\symmsyml+0.5*\symmsyml)--(3*\l,\x*2*\symmsyml);
\draw[dashed,blue, line width=0.75mm] (3*\l+\symmsymh+0.5*\symmsyml,\x*2*\symmsyml-0.25*\symmsyml,0)arc (0:360:0.25*\symmsyml);
\draw[dashed,blue, line width=0.75mm] (3*\l+\symmsymh+0.5*\symmsyml,\x*2*\symmsyml+0.25*\symmsyml,0)arc (0:360:0.25*\symmsyml);}
...
\draw[->,line width=1.25mm] (4*\l,6*\l) -- (5*\l,6*\l)node[right] {\Huge$\mathbf{0^{\circ}}$};
\draw[->,line width=1.25mm] (4*\l,-6*\l) -- (5*\l,-6*\l)node[right] {\Huge$\mathbf{0^{\circ}}$};
