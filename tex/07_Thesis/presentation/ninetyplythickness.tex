...
\begin{scope}[style=axes]
  \draw[->,line width=0.75mm] (-3.2*\l,0) -- (43.4*\l,0) node[right] {\Huge$x$};
  \draw[->,line width=0.75mm] (20*\l,-9.2*\l) -- (20*\l,9.3*\l) node[above] {\Huge$z$};
\end{scope}
...
\draw[line width=1.25mm] (-3*\l,3*\l) -- (43*\l,3*\l) ;
\draw[line width=1.25mm] (-3*\l,-3*\l) -- (43*\l,-3*\l) ;
\draw[line width=1.25mm] (43*\l,9*\l) -- (43*\l,-9*\l);
\draw[line width=1.25mm] (-3*\l,9*\l) -- (-3*\l,-9*\l);
\draw[line width=1.25mm] (-3*\l,9*\l) -- (43*\l,9*\l) ;
\draw[line width=1.25mm] (-3*\l,-9*\l) -- (43*\l,-9*\l) ;

\draw[->,line width=2.75mm] (44*\l,0) -- (45*\l,0) ;
\draw[above] (44.5*\l,0.5)node{\Huge$\varepsilon_{x}=1\%$};

\draw[->,line width=2.75mm] (-4*\l,0) -- (-5*\l,0) ;
\draw[below] (-4.5*\l,-0.5)node{\Huge$\varepsilon_{x}=1\%$};

\draw[below]  (20*\l,-3.5*\l)node{\Huge$\mathbf{11\times k-m\cdot t_{90^ {\circ}}}$};
