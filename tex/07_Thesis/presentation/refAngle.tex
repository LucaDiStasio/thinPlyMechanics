...
\begin{scope}[style=axes]
  \draw[->,line width=0.75mm] (-0.5*\symmsyml-\symmsymh-4*\loadlim,0) -- (0.5*\symmsyml+\symmsymh+4*\loadlim,0) node[right] {\Huge$x$};
  \draw[->,line width=0.75mm] (0,-1.3*\l) -- (0,1.3*\l) node[above] {\Huge$z$};
\end{scope}
...
\draw[draw=black,line width=1.25mm](2*\l+\Rf,0.0) arc(0:180.0:\Rf);
\draw[draw=black,line width=1.25mm](4*\l+\Rf,0.0) arc(0:180.0:\Rf);
...
\draw[draw=black,line width=1.25mm](\Rf,0.0) arc(0:-180.0:\Rf);
...
\draw[->,draw=blue!50!black,line width=1.25mm](0.6*\costheta*\Rf,0.6*\sintheta*\Rf) arc(\thetavalue:\thetaupcz:0.6*\Rf);
\draw (0.35*\costhetahalfup*\Rf,0.7*\sinthetahalfup*\Rf) node[blue!50!black] {\Huge$\psi$};
...
\draw[draw=blue!50!black,line width=1.25mm](\costhetaupcz,\sinthetaupcz) arc(50:0:\Rf);
