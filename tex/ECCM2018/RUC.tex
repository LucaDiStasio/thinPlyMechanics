...
\begin{scope}[style=axes]
  \draw[->,line width=0.75mm] (-1.25*\loadlim,0) -- (1.1*\loadlim,0) node[right] {\Huge$\underline{i}, x$};
  \draw[->,line width=0.75mm] (0,-1.25*\l) -- (0,1.2*\l) node[above] {\Huge$\underline{k}, z$};
\end{scope}
