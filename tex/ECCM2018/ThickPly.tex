...
\draw[line width=1.25mm] (\costhetaup,2*\l+\sinthetaup)arc (\thetaup:\thetaround:\Rf);
\draw[draw=red,line width=1.25mm](\costhetaup,2*\l+\sinthetaup) arc(\thetaup:\thetabot:\Rf);

\draw[line width=1.25mm] (2*\l-\costhetaup,2*\l-\sinthetaup,0)arc (180+\thetaup:360+90+\thetaup:\Rf);
\draw[draw=red,line width=1.25mm](2*\l-\costhetaup,2*\l-\sinthetaup) arc(180-\thetaup:180+\thetabot:\Rf);

\draw[line width=1.25mm] (-2*\l-\costhetaup,2*\l-\sinthetaup,0)arc (180+\thetaup:360+90+\thetaup:\Rf);
\draw[draw=red,line width=1.25mm](-2*\l-\costhetaup,2*\l-\sinthetaup) arc(180-\thetaup:180+\thetabot:\Rf);

\draw[line width=1.25mm] (4*\l+\costhetaup,2*\l+\sinthetaup)arc (\thetaup:\thetaround:\Rf);
\draw[draw=red,line width=1.25mm](4*\l+\costhetaup,2*\l+\sinthetaup) arc(\thetaup:\thetabot:\Rf);
...
\begin{scope}[style=axes]
  ...
  \draw[->,line width=0.75mm] (0,-3.2*\l) -- (0,3.2*\l) node[above] {\Huge$\underline{k}, z$};
\end{scope}
