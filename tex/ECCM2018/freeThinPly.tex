...
\draw (2*\l+\Rf,0)arc (0:360:\Rf);
\draw[draw=red,line width=2pt](2*\l-\costhetaup,-\sinthetaup) arc(180-\thetaup:180+\thetabot:\Rf);

\draw (-2*\l+\Rf,0)arc (0:360:\Rf);
\draw[draw=red,line width=2pt](-2*\l-\costhetaup,-\sinthetaup) arc(180-\thetaup:180+\thetabot:\Rf);

\draw (4*\l+\costhetaup,\sinthetaup)arc (\thetaup:\thetaround:\Rf);
\draw[draw=red,line width=2pt](4*\l+\costhetaup,\sinthetaup) arc(\thetaup:\thetabot:\Rf);

\draw (-4*\l+\costhetaup,\sinthetaup)arc (\thetaup:\thetaround:\Rf);
\draw[draw=red,line width=2pt](-4*\l+\costhetaup,\sinthetaup) arc(\thetaup:\thetabot:\Rf);

\begin{scope}[style=axes]
  \draw[->] (-5.1*\l,0) -- (5.1*\l,0) node[right] {$\underline{i}, x$};
  \draw[->] (0,-1.2*\l) -- (0,1.2*\l) node[above] {$\underline{k}, z$};
\end{scope}
...
\draw (-0.5*\Rf*\cosfourtyfive,0.5*\Rf*\cosfourtyfive) node[black,above] {$R_{f}$};
...
\draw (\costheta*1.05*\Rf,\sintheta*1.05*\Rf) node[red!50!black,above] {$a$};
...
\draw (0,0)--(-\Rf*\cosfourtyfive,\Rf*\cosfourtyfive);
