...
\subfloat[\small Flaggs \& Kural, 1982]{\includegraphics[width=0.9\columnwidth,height=0.125\textheight]{insitustrength.pdf}}
\end{figure}
     \end{center}
\end{column}
...
\begin{figure}[!h]
\centering
     \subfloat[\small Dr. R. Olsson, Swerea, SE.]{\includegraphics[width=0.9\columnwidth]{all-cracks.png}}\\
\subfloat[\small Prof. Dr. E. K. Gamstedt, KTH, SE.]{\includegraphics[width=0.9\columnwidth,height=0.125\textheight]{intralaminar-cracks.png}}
\end{figure}
     \end{center}
\end{column}
\end{columns}
...
\subfloat[\bfseries Int\'egrale J: $J_{i}=\lim_{\varepsilon\to 0}\int_{\Gamma_{\varepsilon}}\left(W\left(\Gamma\right)n_{i}-n_{j}\sigma_{jk}\frac{\partial u_{k}\left(\Gamma,x_{i}\right)}{\partial x_{i}}\right)d\Gamma$]{\includegraphics[width=\columnwidth]{J-integral.pdf}}
\end{figure}
     \end{center}
\end{column}
\end{columns}
...
\begin{figure}[!h]
\centering
   \subfloat[$\Delta\theta=15^{\circ},\delta=0.4^{\circ},VF_{f}=0.001,\frac{l}{R_{f}}\approx28$]{\includegraphics[width=0.9\columnwidth,height=0.09\textheight]{abq-crack-theta-15.png}}\\
\subfloat[$\Delta\theta=100^{\circ},\delta=0.4^{\circ},VF_{f}=0.001,\frac{l}{R_{f}}\approx28$]{\includegraphics[width=0.9\columnwidth,height=0.09\textheight]{abq-crack-theta-100.png}}
\end{figure}
\end{column}
\begin{column}{0.4\textwidth}  %%<--- here
    \begin{center}
...
\centering
 ...
 \caption{\'Evolution de la dimension de la r\'egione de contact pour le mod\`ele avec surface libre.}
\end{figure}
     \end{center}
\end{column}
\end{columns}
