...
\pgfmathsetmacro\xJ{\R*cos(35)}
\pgfmathsetmacro\yJ{\R*sin(35)}
\pgfmathsetmacro\xK{\R*cos(45)}
\pgfmathsetmacro\yK{\R*sin(45)}

\pgfmathsetmacro\xCTU{1.05*\R*cos(30)}
\pgfmathsetmacro\yCTU{1.05*\R*sin(30)}
\pgfmathsetmacro\xCTL{0.95*\R*cos(30)}
\pgfmathsetmacro\yCTL{0.95*\R*sin(30)}
\pgfmathsetmacro\xAU{1.05*\R*cos(40)}
\pgfmathsetmacro\yAU{1.05*\R*sin(40)}
\pgfmathsetmacro\xAL{0.95*\R*cos(40)}
\pgfmathsetmacro\yAL{0.95*\R*sin(40)}
\pgfmathsetmacro\xBU{1.05*\R*cos(50)}
\pgfmathsetmacro\yBU{1.05*\R*sin(50)}
\pgfmathsetmacro\xBL{0.95*\R*cos(50)}
\pgfmathsetmacro\yBL{0.95*\R*sin(50)}
...
\pgfmathsetmacro\xJBF{0.9*\R*cos(35)}
\pgfmathsetmacro\yJBF{0.9*\R*sin(35)}
\pgfmathsetmacro\xKBF{0.9*\R*cos(45)}
\pgfmathsetmacro\yKBF{0.9*\R*sin(45)}

\pgfmathsetmacro\xL{0.9*\R*cos(22)}
\pgfmathsetmacro\yL{0.9*\R*sin(22)}
\pgfmathsetmacro\xM{0.9*\R*cos(10)}
\pgfmathsetmacro\yM{0.9*\R*sin(10)}
\pgfmathsetmacro\xN{0.945*\R*cos(16)}
\pgfmathsetmacro\yN{0.945*\R*sin(16)}
\pgfmathsetmacro\xO{0.845*\R*cos(16)}
\pgfmathsetmacro\yO{0.845*\R*sin(16)}
\pgfmathsetmacro\xP{1.15*\R*cos(18)}
\pgfmathsetmacro\yP{1.15*\R*sin(18)}
\pgfmathsetmacro\xQ{1.15*\R*cos(8)}
\pgfmathsetmacro\yQ{1.15*\R*sin(8)}
\pgfmathsetmacro\xR{1.095*\R*cos(13)}
\pgfmathsetmacro\yR{1.095*\R*sin(13)}
\pgfmathsetmacro\xS{1.195*\R*cos(13)}
\pgfmathsetmacro\yS{1.195*\R*sin(13)}

\pgfmathsetmacro\xT{0.975*\R*cos(26)}
\pgfmathsetmacro\yT{0.975*\R*sin(26)}
\pgfmathsetmacro\xU{0.875*\R*cos(26)}
\pgfmathsetmacro\yU{0.875*\R*sin(26)}

\pgfmathsetmacro\xV{1.045*\R*cos(24)}
\pgfmathsetmacro\yV{1.045*\R*sin(24)}
\pgfmathsetmacro\xZ{1.145*\R*cos(24)}
\pgfmathsetmacro\yZ{1.145*\R*sin(24)}
...
\pgfmathsetmacro\xJBM{1.1*\R*cos(35)}
\pgfmathsetmacro\yJBM{1.1*\R*sin(35)}
\pgfmathsetmacro\xKBM{1.1*\R*cos(45)}
\pgfmathsetmacro\yKBM{1.1*\R*sin(45)}
...
\foreach \Point in {(\xB,\yB),(\xA,\yA),(\xD,\yD),(\xF,\yF),(\xK,\yK),(\xCTU,\yCTU),(\xCTL,\yCTL),(\xBU,\yBU),(\xAU,\yAU),(\xBL,\yBL),(\xAL,\yAL),(\xL,\yL),(\xM,\yM),(\xN,\yN),(\xO,\yO),(\xP,\yP),(\xQ,\yQ),(\xR,\yR),(\xS,\yS),(\xU,\yU),(\xZ,\yZ)}{
    \fill \Point  circle[radius=0.75pt];
}
\foreach \Point in {(\xBBF,\yBBF),(\xABF,\yABF),(\xCTBF,\yCTBF),(\xCBF,\yCBF),(\xDBF,\yDBF),(\xJBF,\yJBF),(\xKBF,\yKBF)}{
    \fill \Point  circle[radius=0.75pt];
}
\foreach \Point in {(\xBBM,\yBBM),(\xABM,\yABM),(\xCTBM,\yCTBM),(\xEBM,\yEBM),(\xFBM,\yFBM),(\xJBM,\yJBM),(\xKBM,\yKBM)}{
    \fill \Point  circle[radius=0.75pt];
}

\fill[fill=magenta] (\xCT,\yCT)  circle[radius=0.75pt];
\fill[fill=cyan] (\xC,\yC)  circle[radius=0.75pt];
\fill[fill=cyan] (\xE,\yE)  circle[radius=0.75pt];
\fill[fill=magenta] (\xJ,\yJ) circle[radius=0.75pt];
\fill[fill=cyan] (\xT,\yT) circle[radius=0.75pt];
\fill[fill=cyan] (\xV,\yV) circle[radius=0.75pt];
...
\node[anchor= east,text=magenta] at (\xCT,\yCT)  {\Huge \bf{CT1}};
\node[anchor= east,text=magenta] at (0.99*\xJ,\yJ)  {\Huge \bf{CT2}};
\node[anchor= north east,text=cyan] at (1.025*\xC,0.925*\yC)  {\Huge \bf{F1}};
\node[anchor= north west,text=cyan] at (\xE,\yE)  {\Huge \bf{M1}};
\node[anchor= north east,text=cyan] at (\xT,\yT)  {\Huge \bf{F2}};
\node[anchor= north west,text=cyan] at (\xV,\yV)  {\Huge \bf{M2}};
