...
A homogeneous isotropic materia has only $2$ independent parameters that determine its elastic behavior; thus it holds
...
\section{Critique and alternative formulations of $G_{0}$}
