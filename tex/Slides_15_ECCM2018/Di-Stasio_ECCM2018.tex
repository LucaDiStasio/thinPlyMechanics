...
\title[\textsc{FEM \& the Fiber-Matrix Interface Crack}]{\textsc{Effect of boundary conditions on microdamage initiation in thin ply composite laminates}}
\author{ \underline{L. Di Stasio}$^{1,2}$, J. Varna$^{2}$, Z. Ayadi$^{1}$}
...
\date{ECCM18 - Athens (GR), June 24-28, 2018}
